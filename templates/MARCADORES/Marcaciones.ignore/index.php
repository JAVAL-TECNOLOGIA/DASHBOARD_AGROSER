...
<html>
    ...
    color: #fff;
	margin-top: 10px;
	margin-left:120px /* Ajusta el margen derecho según tus necesidades */
}
...
#hours, #minutes, #seconds {
    ...
    border-radius: 5px;
	margin-right: 20px;
	box-shadow: 0 0 10px rgba(255, 255, 255, 0.8); /* Efecto de resplandor blanco (ajusta según tus preferencias) */
       ...
       <div class="container" style="margin-top:5%"> 
		   <div class="wrapper">
            ...
            <canvas id="my_canvas" width="520" height="510"></canvas>
				...
				<div class="col-md-6">
				<h3 style="color:#fff">Marcaciones | Don Luis </h3>
				</div>
                <div class="col-md-6">
				...
				<div class="container-fluid">
					...
					<li><a href="attendance.php"> <span class="glyphicon glyphicon-calendar"></span> </a></li>
					</ul>
				</div>
				</nav>
				<form action="TimeInOut.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                    ...
                    <input type="text" 	 autocomplete="off" name="studentID" id="text" placeholder="Escanear código" class="form-control" autofocus>
					
                </form>
				 <div class="row">
						<div class="col-md-12">
						 <label style="color:#fff">Parametros: </label>
				...
				<div class="row">	
					...
					if (isset($_SESSION['success2'])) {
						echo "
						  <div id='alert' class='alert alert-success' style='background:#eb3b5a; color:#fff; border:none'>
							<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
							<h4><i class='icon fa fa-check'></i> Correcto !</h4>
							" . $_SESSION['success2'] . "
						  </div>
