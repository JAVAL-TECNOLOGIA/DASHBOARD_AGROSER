...
class presupuesto_dl(TemplateView):
    permission_required = 'modulo_evaluaciones'
    template_name = 'EVALUACIONES/pages/evaluaciones_presupuesto_dl.html'
...
def Costo_servicio_totals(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '9', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '9'
            """)
...
class Costo_Servicios_dlView(View):
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, grupo_servicio, subgrupo_servicio, descripcion, precio_unitario, observacion,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_servicios 
                    WHERE id_area = 9 AND ID_CAMPANIA = ?
                    """
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            values.extend([request.user.id,9, id])
...
def Costos_suministros_totals_dl(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS %s, %s", [9, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS %s", [9])
...
class CombustiblesLubricantesView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,9,1,id_campania])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 1 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 1
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,1])
...
class UtilesOficinaView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,9,5,id_campania])
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 5 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 5
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,5])
...
class EquiposComputoView(View): 
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,7,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 7
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 7
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 7 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,7])
...
class OtrosSuministrosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,8,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 8
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 8
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 8 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,8])
...
class MaterialConstruccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,9,4,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 4
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 4
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 4 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,4])
...
class RepuestosAccesoriosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,2,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 2
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,9,2])
...
class EquiposUITView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,9,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 9
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 9
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 9 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,9,9])
...
class MaterialesAgriculturaView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,3,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 3
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 3
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 3 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,3])
...
class EquiposProteccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,6,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 9 AND id_tipo_suministro = 6
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 9 AND id_tipo_suministro = 6
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 9 AND id_tipo_suministro = 6 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,9,6])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 9 AND id_remuneracion = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                cursor.execute("SELECT DISTINCT ID_CAMPANIA FROM tb_remuneracion WHERE id_area = 9 AND id_remuneracion = 1")
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 9 AND id_remuneracion = 1 AND ID_CAMPANIA = ?
                    """
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 9 AND id_remuneracion = 1
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSueldos(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [9, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [9, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
        ...
        try:
            ...
            if id:
                ...
                SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                       ...
                       usuario, fecha,asignacion, vacacion
                FROM tb_remuneracion
                WHERE id = ? AND id_area = 9 AND id_remuneracion = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 9 AND id_remuneracion = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 9 AND id_remuneracion = 2
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSalarios(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [9, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [9, 2])
...
class evaluacion_desempeño(TemplateView):
    permission_required = 'modulo_evaluaciones' 
    template_name = 'EVALUACIONES/components/DonLuis/eva_desempeno/rrhh_evaluacion_desempeño.html'
...
class ObjetivosEvaluacionView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Obtener el parámetro de campaña desde la URL
            ...
            # Ejecutar el procedimiento almacenado con el área 9 y el periodo (solo año)
            cursor.execute("EXEC SP_RESUMEN_RRHH_OBJETIVOS @id_area=?, @periodo=?", [9, campania])
        ...
        try:
            ...
            if 'id_evaluacion' in data:
                ...
                if count > 0:
                    return JsonResponse({
                        'status': 'error',
                        'message': 'Ya existe una evaluación para este colaborador en el periodo ' + str(data['periodo'])
                    }, status=400)
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if objetivo_id:
                ...
                cursor.execute("EXEC RRHH_EV_OBJETIVOS_MEJORA 9")
...
class ResumenCompetenciasView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con el área 9 y el periodo (solo año)
            cursor.execute("EXEC SP_RESUMEN_RRHH_COMPETENCIAS @id_area=?, @periodo=?", [9, campania])
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if competencia_id:
                ...
                # Si no hay ID, ejecutar el procedimiento para todos
                cursor.execute("EXEC RRHH_EV_COMPETENCIAS_MEJORA 9")
...
class presupuesto_cv(TemplateView):
    permission_required = 'modulo_evaluaciones'
    template_name = 'EVALUACIONES/pages/evaluaciones_presupuesto_cv.html'
...
def Costo_servicio_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '9', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '9'
            """)
...
def Costos_suministros_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s, %s", [9, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s", [9])
...
def Costos_capex_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '9', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '9'
            """)
...
class ApiMensualSueldos_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [9, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [9, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [9, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [9, 2])
...
class presupuesto_ajs(TemplateView):
    permission_required = 'modulo_evaluaciones'
    template_name = 'EVALUACIONES/pages/evaluaciones_presupuesto_ajs.html'
...
def Costo_servicio_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '9', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '9'
            """)
...
def Costos_suministros_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s, %s", [9, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s", [9])
...
def Costos_capex_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '9', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '9'
            """)
...
class ApiMensualSueldos_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [9, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [9, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [9, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [9, 2])
