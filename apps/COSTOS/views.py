...
class presupuesto_dl(TemplateView):
    permission_required = 'ver_costos'
    template_name = 'COSTOS/pages/presupuesto_dl.html'
...
def Costo_servicio_totals(request):
    ...
    with connection.cursor() as cursor:
        #TOTAL DE SERVICIOS PARA EL AREA COSTOS
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '6', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '6' 
            """)
...
class Costo_Servicios_dlView(View):
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, grupo_servicio, subgrupo_servicio, descripcion, precio_unitario, observacion,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_servicios 
                    WHERE id_area = 6 AND ID_CAMPANIA = ?
                    """
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            values.extend([request.user.id,6, id])
...
class CombustiblesLubricantesView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,6,1,id_campania])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 1 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 1
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,1])
...
class UtilesOficinaView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,6,5,id_campania])
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 5 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 5 
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,5])
...
class EquiposComputoView(View): 
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,7,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 7
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 7 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 7
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,7])
...
class OtrosSuministrosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,8,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 8
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 8 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 8
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,8])
...
class MaterialConstruccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,6,4,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 4
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 4 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 4
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,4])
...
class RepuestosAccesoriosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,2,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 2
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,6,2])
...
class EquiposUITView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,9,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 9
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 9 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 9
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,6,9])
...
class MaterialesAgriculturaView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,3,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 3
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 3 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 3
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,3])
...
class EquiposProteccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,6,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 6 AND id_tipo_suministro = 6
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 6 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 6 AND id_tipo_suministro = 6
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,6,6])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 6 AND id_remuneracion = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 6 AND id_remuneracion = 1 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 6 AND id_remuneracion = 1
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSueldos(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [6, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [6, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
        ...
        try:
            ...
            if id:
                ...
                SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                       ...
                       usuario, fecha,asignacion, vacacion
                FROM tb_remuneracion
                WHERE id = ? AND id_area = 6 AND id_remuneracion = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 6 AND id_remuneracion = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 6 AND id_remuneracion = 2
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSalarios(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado
            cursor.execute("exec rpt_pst_remuneracion '6','2'")
...
class evaluacion_desempeño(TemplateView):
    permission_required = 'ver_costos' 
    template_name = 'COSTOS/components/DonLuis/eva_desempeno/rrhh_evaluacion_desempeño.html'
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Ejecutar el procedimiento almacenado con el área 4 hardcodeada
                cursor.execute("EXEC SP_RESUMEN_RRHH_OBJETIVOS @id_area=?, @periodo=?", [6, periodo])
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if objetivo_id:
                ...
                cursor.execute("EXEC RRHH_EV_OBJETIVOS_MEJORA 6")
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if competencia_id:
                ...
                # Si no hay ID, ejecutar el procedimiento para todos
                cursor.execute("EXEC RRHH_EV_COMPETENCIAS_MEJORA 6")
...
# REPORTE DE HORAS PERSONAL POR AREA
#TEMPLATE
class ReporteResumenHorasViewTemplate(TemplateView):
    template_name = 'COSTOS/components/DonLuis/reportes/costos_rpt_horas_personal.html'   
    permission_required = 'ver_costos'
...
# API PARA GENERAR EL REPORTE DE HORAS PERSONAL POR AREA

@method_decorator(csrf_exempt, name='dispatch')
class ReporteResumenHorasViewApi(View):
    """
    API para generar el Reporte de Resumen de Horas del personal.
    Ejecuta el procedimiento almacenado PLAN_RESUMEN_HORAS_DL.
    Acepta peticiones GET y POST.
    """

    def handle_report_logic(self, data):
        cursor = None
        try:
            # --- Parámetros del reporte ---
            id_empresa = data.get('id_empresa', '001')
            fecha_inicio = data.get('fecha_inicio')
            fecha_fin = data.get('fecha_fin')
            regimen = data.get('regimen')
            detallado_fechas = int(data.get('detallado_fechas', 1))
            tipo_filtro = data.get('tipo_filtro', 'A')
            dato_principal = data.get('dato', '')
            dato_secundario = data.get('dato2', '')
            detallado = int(data.get('detallado', 1))
            resumen = int(data.get('resumen', 0))
            subplanilla = data.get('subplanilla', 'XX')

            # --- Validaciones ---
            if not all([fecha_inicio, fecha_fin, regimen]):
                return JsonResponse({
                    'status': 'error',
                    'message': 'Los parámetros fecha_inicio, fecha_fin y regimen son obligatorios.'
                }, status=400)

            if regimen not in ['OBR', 'GEN']:
                return JsonResponse({
                    'status': 'error',
                    'message': "El parámetro regimen es inválido. Debe ser 'OBR' o 'GEN'."
                }, status=400)
            
            id_planilla = regimen

            # --- Conexión y ejecución del SP ---
            # 1. VERIFICA QUE ESTA CONEXIÓN APUNTE A LA BASE DE DATOS CORRECTA
            cursor = connection_donluis.cursor()
            
            # 2. VERIFICA QUE ESTE NOMBRE COINCIDA EXACTAMENTE CON EL NOMBRE EN TU BASE DE DATOS
            sql_query = """
                EXEC PLAN_RESUMEN_HORAS_DL ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
            """
            
            params = (
                id_empresa, fecha_inicio, fecha_fin, id_planilla,
                detallado_fechas, tipo_filtro, dato_principal, dato_secundario,
                detallado, resumen, subplanilla
            )
    ...
    def get(self, request, *args, **kwargs):
        # Para peticiones GET, los parámetros vienen en la URL (request.GET)
        data = request.GET
        return self.handle_report_logic(data)

    def post(self, request, *args, **kwargs):
        # Para peticiones POST, los parámetros vienen en el body (request.body)
        try:
            data = json.loads(request.body)
            return self.handle_report_logic(data)
        except json.JSONDecodeError:
...
class presupuesto_cv(TemplateView):
    permission_required = 'ver_costos'
    template_name = 'COSTOS/pages/costos_presupuesto_cv.html'
...
def Costo_servicio_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '6', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '6'
            """)
...
def Costos_suministros_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s, %s", [6, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s", [6])
...
class CombustiblesLubricantesView_cv(View):
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,7,1])
...
def Costos_capex_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '6', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '6'
            """)
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                cursor.execute("SELECT DISTINCT ID_CAMPANIA FROM tb_remuneracion WHERE id_area = 6 AND id_remuneracion = 1")
...
class ApiMensualSueldos_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [6, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [6, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [6, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [6, 2])
...
class presupuesto_ajs(TemplateView):
    permission_required = 'ver_costos'
    template_name = 'COSTOS/pages/costos_presupuesto_ajs.html'
...
def Costo_servicio_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '6', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '6'
            """)
...
def Costos_suministros_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s, %s", [6, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s", [6])
...
def Costos_capex_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '6', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '6'
            """)
...
class ApiMensualSueldos_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [6, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [6, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [6, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [6, 2])
...
""" class Distribucion_costo_cv (TemplateView):
    permission_required = 'ver_costos'
    template_name = 'script/distribucion_costo_cv.html'


class Distribucion_costo_ajs (TemplateView):
    permission_required = 'ver_costos'
    template_name = 'script/distribucion_costo_ajs.html'

 """



""" class Distribucion_costo_script(View):
    def get(self, request, *args, **kwargs):

        with connection_donluis.cursor() as cursor:
            cursor.execute("EXEC SP_DISTRIBUCION_COSTOS_DETALLE '202201','202412'")
        ...
        for data in data_object:
            ...
            data_json.append({
                ...
                'cargo':data[12],
                'abono':data[13],
                'fechacreacion':data[14],
                'sincroniza':data[15],
                'idestado':data[16],
                'centralizado':data[17],
                'ventana':data[18],
                'contabilizado':data[19],
                'es_apertura':data[20],
                'es_cierre':data[21],
                'idclieprov':data[22],
                'iddocumento':data[23],
                'idctareclasific':data[24],
                'idctacobranza':data[25],
                'idctaprovision':data[26],
                'idccosto':data[27],
                'TCMONEDA':data[28],
                'CORRELATIVO_PLE':data[29],
                'IDINGRESOSALIDAACTIVO':data[30],
                'viene_cierre':data[31],
                'tipo_cierre':data[32],
                'idcierre':data[33],
                'IDTIPOMEDIOPAGO':data[34],
                'idtransf_23':data[35],
                'idprocesogenaplicacion':data[36],
                'observaciones':data[37],
                'idreferencia':data[38],
                'tablaref':data[39],
                'docreferencia':data[40],
                'ventana_ref':data[41],
                'idcontrato':data[42],
                'numversion':data[43],
                'idclaseccosto_distribucion':data[44],
                'origen_distribucion':data[45],
                'idorigen2':data[46],
                'idplantillacierre':data[47]

            })
        return JsonResponse(data_json, safe=False)

class Distribucion_costo_cv_script(View):
    def get(self, request, *args, **kwargs):
...
class Distribucion_costo_ajs_script(View):
    def get(self, request, *args, **kwargs):
