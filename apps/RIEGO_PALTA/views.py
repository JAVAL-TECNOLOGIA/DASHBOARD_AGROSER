...
#FECHA: 06/01/2023
#MODIFICACIONES: 
# 01/01/2023: Se crea el modulo de presupuestos
#=================================================================================================================
...
class presupuesto_dl(TemplateView):
    ...
    template_name = 'RIEGO_PALTA/pages/riegopalta_presupuesto_dl.html'
...
def Costo_servicio_totals(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '23', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '23'
            """)
...
class Costo_Servicios_dlView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,23,id_campania]) 
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, grupo_servicio, subgrupo_servicio, descripcion, precio_unitario, observacion,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_servicios 
                    WHERE id_area = 23 AND ID_CAMPANIA = ?
                    """
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            values.extend([request.user.id,23, id])
...
class CombustiblesLubricantesView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,23,1,id_campania])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 1 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 1
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,1])
...
class UtilesOficinaView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,23,5,id_campania])
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 5 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 5
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,5])
...
class EquiposComputoView(View): 
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,7,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 7
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 7
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 7 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,7])
...
class OtrosSuministrosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,8,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 8
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 8
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 8 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,8])
...
class MaterialConstruccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,23,4,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 4
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 4
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 4 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,4])
...
class RepuestosAccesoriosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,2,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 2
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,23,2])
...
class EquiposUITView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,9,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 9
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 9
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 9 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,23,9])
...
class MaterialesAgriculturaView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,3,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 3
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 3
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 3 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,3])
...
class EquiposProteccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,6,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 23 AND id_tipo_suministro = 6
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 23 AND id_tipo_suministro = 6
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 23 AND id_tipo_suministro = 6 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,6])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 23 AND id_remuneracion = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                cursor.execute("SELECT DISTINCT ID_CAMPANIA FROM tb_remuneracion WHERE id_area = 23 AND id_remuneracion = 1")
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 23 AND id_remuneracion = 1 AND ID_CAMPANIA = ?
                    """
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 23 AND id_remuneracion = 1
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSueldos(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [23, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [23, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
        ...
        try:
            ...
            if id:
                ...
                SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                       ...
                       usuario, fecha,asignacion, vacacion
                FROM tb_remuneracion
                WHERE id = ? AND id_area = 23 AND id_remuneracion = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 23 AND id_remuneracion = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 23 AND id_remuneracion = 2
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSalarios(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [23, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [23, 2])
...
class presupuesto_cv(TemplateView):
    ...
    template_name = 'RIEGO_PALTA/pages/riegopalta_presupuesto_cv.html'
...
def Costo_servicio_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '23', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '23'
            """)
...
def Costos_suministros_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s, %s", [23, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s", [23])
...
def Costos_capex_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '23', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '23'
            """)
...
class ApiMensualSueldos_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [23, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [23, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [23, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [23, 2])
...
class presupuesto_ajs(TemplateView):
    permission_required = 'modulo_produccion_palta'
    template_name = 'RIEGO_PALTA/pages/riegopalta_presupuesto_ajs.html'
...
def Costo_servicio_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '23', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '23'
            """)
...
def Costos_suministros_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s, %s", [23, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s", [23])
...
class EquiposComputoView_ajs(View): 
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,23,id_campania])
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,23,23])
...
def Costos_capex_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '23', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '23'
            """)
...
class ApiMensualSueldos_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [23, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [23, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [23, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [23, 2])
...
class ResumenFertilizacionView(View):
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                FROM RIEGO_PREFERTILIZACION_PALTA p
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO RIEGO_PREFERTILIZACION_PALTA
            ...
            cursor.execute("SELECT IDENT_CURRENT('RIEGO_PREFERTILIZACION_PALTA')")
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE RIEGO_PREFERTILIZACION_PALTA 
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM RIEGO_PREFERTILIZACION_PALTA WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class DetallePreFertilizacionView(View):
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                FROM RIEGO_DPREFERTILIZACION_PALTA d
                WHERE d.ID = ?
                """
                cursor.execute(query, [id])
                ...
                FROM RIEGO_DPREFERTILIZACION_PALTA d
                INNER JOIN RIEGO_PREFERTILIZACION_PALTA p ON d.IDRIEGO_PREFERTILIZACION = p.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO RIEGO_DPREFERTILIZACION_PALTA (
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) FROM RIEGO_DPREFERTILIZACION_PALTA WHERE ID = ?", [id])
            if cursor.fetchone()[0] == 0:
                cursor.close()
                return JsonResponse({
                    'status': 'error',
            ...
            query = """
            UPDATE RIEGO_DPREFERTILIZACION_PALTA SET
                SUBGRUPO = ?,
                PRODUCTO = ?,
                MATERIA_ACTIVA = ?,
                NECESIDADXHA = ?,
    ...
    def delete(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            query = "DELETE FROM RIEGO_DPREFERTILIZACION_PALTA WHERE ID = ?"
...
class ResumenFertilizacionCVView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM RIEGO_PREFERTILIZACION_PALTA_CV p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO RIEGO_PREFERTILIZACION_PALTA_CV 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('RIEGO_PREFERTILIZACION_PALTA_CV')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE RIEGO_PREFERTILIZACION_PALTA_CV 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM RIEGO_PREFERTILIZACION_PALTA_CV WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class DetallePreFertilizacionCVView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT d.ID, d.IDRIEGO_PREFERTILIZACION, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       d.SUBGRUPO, d.PRODUCTO, d.MATERIA_ACTIVA, d.NECESIDADXHA, 
                       d.UND, d.PRECIO_LTKG, d.PRECIO_HA, d.OBSERVACIONES, d.FECHA_CREACION
                FROM RIEGO_DPREFERTILIZACION_PALTA_CV d
                WHERE d.ID = ?
                """
                cursor.execute(query, [id])
                ...
                SELECT d.ID, d.IDRIEGO_PREFERTILIZACION, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       ...
                       p.NOMBRE as PLAN_FERTILIZACION
                FROM RIEGO_DPREFERTILIZACION_PALTA_CV d
                INNER JOIN RIEGO_PREFERTILIZACION_PALTA_CV p ON d.IDRIEGO_PREFERTILIZACION = p.ID
                ORDER BY d.FECHA_CREACION DESC
                """
                cursor.execute(query)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            # Preparar la consulta SQL para insertar el nuevo producto
            query = """
            INSERT INTO RIEGO_DPREFERTILIZACION_PALTA_CV (
                IDRIEGO_PREFERTILIZACION, IDPRODUCTO, IDSUBGRUPO, 
                SUBGRUPO, PRODUCTO, MATERIA_ACTIVA, 
                NECESIDADXHA, UND, PRECIO_LTKG, 
                PRECIO_HA, OBSERVACIONES, FECHA_CREACION
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Verificar que el producto existe
            cursor.execute("SELECT COUNT(*) FROM RIEGO_DPREFERTILIZACION_PALTA_CV WHERE ID = ?", [id])
            if cursor.fetchone()[0] == 0:
                cursor.close()
                return JsonResponse({
                    'status': 'error',
            ...
            # Preparar la consulta SQL para actualizar el producto
            query = """
            UPDATE RIEGO_DPREFERTILIZACION_PALTA_CV SET
                SUBGRUPO = ?,
                PRODUCTO = ?,
                MATERIA_ACTIVA = ?,
                NECESIDADXHA = ?,
    ...
    def delete(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Preparar la consulta SQL para eliminar el producto
            query = "DELETE FROM RIEGO_DPREFERTILIZACION_PALTA_CV WHERE ID = ?"
...
class ResumenFertilizacionAJSView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM RIEGO_PREFERTILIZACION_PALTA_AJS p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO RIEGO_PREFERTILIZACION_PALTA_AJS 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('RIEGO_PREFERTILIZACION_PALTA_AJS')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE RIEGO_PREFERTILIZACION_PALTA_AJS 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM RIEGO_PREFERTILIZACION_PALTA_AJS WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class DetallePreFertilizacionAJSView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT d.ID, d.IDRIEGO_PREFERTILIZACION, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       d.SUBGRUPO, d.PRODUCTO, d.MATERIA_ACTIVA, d.NECESIDADXHA, 
                       d.UND, d.PRECIO_LTKG, d.PRECIO_HA, d.OBSERVACIONES, d.FECHA_CREACION
                FROM RIEGO_DPREFERTILIZACION_PALTA_AJS d
                WHERE d.ID = ?
                """
                cursor.execute(query, [id])
                ...
                SELECT d.ID, d.IDRIEGO_PREFERTILIZACION, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       ...
                       p.NOMBRE as PLAN_FERTILIZACION
                FROM RIEGO_DPREFERTILIZACION_PALTA_AJS d
                INNER JOIN RIEGO_PREFERTILIZACION_PALTA_AJS p ON d.IDRIEGO_PREFERTILIZACION = p.ID
                ORDER BY d.FECHA_CREACION DESC
                """
                cursor.execute(query)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            # Preparar la consulta SQL para insertar el nuevo producto
            query = """
            INSERT INTO RIEGO_DPREFERTILIZACION_PALTA_AJS (
                IDRIEGO_PREFERTILIZACION, IDPRODUCTO, IDSUBGRUPO, 
                SUBGRUPO, PRODUCTO, MATERIA_ACTIVA, 
                NECESIDADXHA, UND, PRECIO_LTKG, 
                PRECIO_HA, OBSERVACIONES, FECHA_CREACION
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Verificar que el producto existe
            cursor.execute("SELECT COUNT(*) FROM RIEGO_DPREFERTILIZACION_PALTA_AJS WHERE ID = ?", [id])
            if cursor.fetchone()[0] == 0:
                cursor.close()
                return JsonResponse({
                    'status': 'error',
            ...
            # Preparar la consulta SQL para actualizar el producto
            query = """
            UPDATE RIEGO_DPREFERTILIZACION_PALTA_AJS SET
                SUBGRUPO = ?,
                PRODUCTO = ?,
                MATERIA_ACTIVA = ?,
                NECESIDADXHA = ?,
    ...
    def delete(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Preparar la consulta SQL para eliminar el producto
            query = "DELETE FROM RIEGO_DPREFERTILIZACION_PALTA_AJS WHERE ID = ?"
