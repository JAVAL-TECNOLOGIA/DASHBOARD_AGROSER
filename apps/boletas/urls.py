...
from .views import AttendanceKioskView, AttendanceScreenView, AttendanceServiceWorkerView, PaySlipConsolidatedView, PaySlipListView, PaySlipPdfView, PayrollReleaseWorkflowView, WorkerPhotoView, WorkerSignatureView, WorkerDetailView, WorkerMonthPdfView, WorkerBadgeSheetView, WorkerPasswordResetView, WorkerIdentityResetView
...
urlpatterns = [
    ...
    path('marcaciones/pantalla/', AttendanceScreenView.as_view(), name='attendance_screen'),
    path('marcaciones/service-worker.js', AttendanceServiceWorkerView.as_view(), name='attendance_service_worker'),
    ...
    path('publicacion/', PayrollReleaseWorkflowView.as_view(), name='release_workflow'),
