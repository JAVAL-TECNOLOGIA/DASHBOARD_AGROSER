...
urlpatterns = [
    ...
    path('riegouva_presupuesto_dl/', presupuesto_dl.as_view(), name='riegouva_presupuesto_dl'),
    ...
    path('riegouva_presupuesto_cv/', presupuesto_cv.as_view(), name='riegouva_presupuesto_cv'),
...
#====================================================================================================================
    ...
    path('riegouva_presupuesto_ajs/', presupuesto_ajs.as_view(), name='riegouva_presupuesto_ajs'),
