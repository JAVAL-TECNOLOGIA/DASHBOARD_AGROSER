...
class presupuesto_dl(TemplateView):
    ...
    template_name = 'PRODUCCION_PALTA/pages/produccionpalta_presupuesto_dl.html'
...
def Costo_servicio_totals(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '15', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS '15'
            """)
...
class Costo_Servicios_dlView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # # Verificar si ya existe la observacion para esta e�rea
            # check_query = """
            # SELECT COUNT(*) 
            #     FROM TIC_servicios 
            #     WHERE observacion = ? 
            ...
            # area_id = data.get('id_area', 12)
            # if observacion:  # Solo verificar si hay una observacion
            ...
            #         return JsonResponse({
            #             'status': 'error',
            #             'message': 'Ya existe un servicio con esta observacion en esta e�rea'
            #         }, status=400)
            ...
            values.extend([request.user.id,15,id_campania]) 
            ...
            if id:
                ...
                if campania:
                    ...
                    SELECT id, idproducto, grupo_servicio, subgrupo_servicio, descripcion, precio_unitario, observacion,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio, ID_CAMPANIA
                    FROM TIC_servicios 
                    WHERE id_area = 15 AND ID_CAMPANIA = ?
                    """
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            values = [
                ...
                data['grupo_servicio'],
                data['subgrupo_servicio'],
                self.clean_descripcion(data.get('descripcion', '')),
                precio_unitario,
                data.get('observacion', ''),
            ]
            ...
            values.extend([request.user.id,15, id])
...
class CombustiblesLubricantesView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,15,1,id_campania])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 1 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                        ...
                        noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 1
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,1])
...
class UtilesOficinaView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,15,5,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 5 
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 5 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 5
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,5])
...
class EquiposComputoView(View): 
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,7,id_campania])
    ...
    # El me�todo GET permanece sin cambios
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 7
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 15 AND id_tipo_suministro = 7
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 7 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,7])
...
class OtrosSuministrosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,8,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 8
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 15 AND id_tipo_suministro = 8
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 8 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,8])
...
class MaterialConstruccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            values.extend([request.user.id,15,4,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 4
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 15 AND id_tipo_suministro = 4
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 4 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,4])
...
class RepuestosAccesoriosView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,2,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 15 AND id_tipo_suministro = 2
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,15,2])
...
class EquiposUITView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,9,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 9
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 15 AND id_tipo_suministro = 9
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 9 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
            try:
                ...
                # Agregar el nombre completo del usuario al final de la lista de valores
                values.extend([request.user.id,15,9])
...
class MaterialesAgriculturaView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,3,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 3
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id_area = 15 AND id_tipo_suministro = 3
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 3 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,3])
...
class EquiposProteccionView(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,6,id_campania])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM TIC_suministros
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 6 
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                        ...
                        noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 6 AND ID_CAMPANIA = ?
                    """
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM TIC_suministros
                    WHERE id_area = 15 AND id_tipo_suministro = 6 
                    """
                    cursor.execute(query)
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,6])
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                WHERE id = ? AND id_area = 15 AND id_remuneracion = 1
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 15 AND id_remuneracion = 1 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 15 AND id_remuneracion = 1
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSueldos(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [15, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [15, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
        ...
        try:
            ...
            if id:
                ...
                SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                       ...
                       usuario, fecha,asignacion, vacacion
                FROM tb_remuneracion
                WHERE id = ? AND id_area = 15 AND id_remuneracion = 2
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                if campania:
                    ...
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 15 AND id_remuneracion = 2 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    query = """
                    SELECT id, dni, nombre, regimen_laboral, cargo, fecha_ingreso,
                           ...
                           usuario, fecha,asignacion, vacacion
                    FROM tb_remuneracion 
                    WHERE id_area = 15 AND id_remuneracion = 2
                    """
                    cursor.execute(query)
                columns = [column[0] for column in cursor.description]
                data = []
...
class ApiMensualSalarios(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion ?, ?, ?", [15, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion ?, ?", [15, 2])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class evaluacion_desempeño(TemplateView):
    permission_required = 'modulo_produccion_palta' 
    template_name = 'PRODUCCION_PALTA/components/DonLuis/rrhh_evaluacion_desempeño.html'
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Ejecutar el procedimiento almacenado con el área 4 hardcodeada
                cursor.execute("EXEC SP_RESUMEN_RRHH_OBJETIVOS @id_area=?, @periodo=?", [15, periodo])
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if objetivo_id:
                ...
                cursor.execute("EXEC RRHH_EV_OBJETIVOS_MEJORA 15")
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if competencia_id:
                ...
                # Si no hay ID, ejecutar el procedimiento para todos
                cursor.execute("EXEC RRHH_EV_COMPETENCIAS_MEJORA 15")
...
class presupuesto_cv(TemplateView):
    permission_required = 'modulo_produccion_palta'
    template_name = 'PRODUCCION_PALTA/pages/produccionpalta_presupuesto_cv.html'
...
def Costo_servicio_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '15', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_CV '15'
            """)
...
def Costos_suministros_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s, %s", [15, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_CV %s", [15])
...
def Costos_capex_totals_cv(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '15', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_CV '15'
            """)
    ...
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                cursor.execute("SELECT DISTINCT ID_CAMPANIA FROM tb_remuneracion WHERE id_area = 15 AND id_remuneracion = 1")
...
class ApiMensualSueldos_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [15, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [15, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_cv(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?, ?", [15, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_cv ?, ?", [15, 2])
...
class presupuesto_ajs(TemplateView):
    permission_required = 'modulo_produccion_palta'
    template_name = 'PRODUCCION_PALTA/pages/produccionpalta_presupuesto_ajs.html'
...
def Costo_servicio_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        ...
        if campania:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '15', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC TOTAL_SERVICIOS_AJS '15'
            """)
...
def Costos_suministros_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s, %s", [15, campania])
        else:
            cursor.execute("EXEC RPT_PST_SUMINISTROS_AJS %s", [15])
...
class EquiposComputoView_ajs(View): 
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,15,id_campania])
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            # Agregar el nombre completo del usuario al final de la lista de valores
            values.extend([request.user.id,15,15])
        ...
        try:
            ...
            if id:
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM SUMINISTRO_AJS
                WHERE id = ? AND id_area = 15 AND id_tipo_suministro = 15
                """
                cursor.execute(query, [id])
                columns = [column[0] for column in cursor.description]
                row = cursor.fetchone()
                ...
                SELECT id, idproducto, descripcion,precio_unitario,
                       ...
                       noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                FROM SUMINISTRO_AJS
                WHERE id_area = 15 AND id_tipo_suministro = 15
                """
                # Filtrar por campaña si se proporciona el parametro year
                campania = request.GET.get('year', '')
                if campania:
                    ...
                    SELECT id, idproducto, descripcion,precio_unitario,
                           ...
                           noviembre_cantidad, noviembre_precio, diciembre_cantidad, diciembre_precio
                    FROM SUMINISTRO_AJS
                    WHERE id_area = 15 AND id_tipo_suministro = 15 AND ID_CAMPANIA = ?
                    """
                    cursor.execute(query, [campania])
                else:
                    cursor.execute(query)
...
def Costos_capex_totals_ajs(request):
    ...
    with connection.cursor() as cursor:
        if campania:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '15', %s
            """, [campania])
        else:
            cursor.execute("""
                EXEC RPT_PST_CAPEX_AJS '15'
            """)
...
class ApiMensualSueldos_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [15, 1, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [15, 1])
                        # Obtener los nombres de las columnas
            columns = [column[0] for column in cursor.description]
            # Obtener los resultados
            results = cursor.fetchall()
...
class ApiMensualSalarios_ajs(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Ejecutar el procedimiento almacenado con o sin campaña
            if campania:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?, ?", [15, 2, campania])
            else:
                cursor.execute("exec rpt_pst_remuneracion_ajs ?, ?", [15, 2])
...
class OrgResumenMateriaOrganicaView(View):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO MATERIA_ORGANICA_PALTA
            ...
            cursor.execute("SELECT IDENT_CURRENT('MATERIA_ORGANICA_PALTA')")
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM MATERIA_ORGANICA_PALTA WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class OrgDetalleMateriaOrganicaView(View):
    def get(self, request, id=None, *args, **kwargs):
        try:
            ...
            if id:
                ...
                FROM MATERIA_DORGANICA_PALTA d
                WHERE d.ID = ?
                """
                cursor.execute(query, [id])
                ...
                FROM MATERIA_DORGANICA_PALTA d
                INNER JOIN MATERIA_ORGANICA_PALTA p ON d.IDMATERIA_ORGANICA = p.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO MATERIA_DORGANICA_PALTA (
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) FROM MATERIA_DORGANICA_PALTA WHERE ID = ?", [id])
            if cursor.fetchone()[0] == 0:
                cursor.close()
                return JsonResponse({
                    'status': 'error',
            ...
            query = """
            UPDATE MATERIA_DORGANICA_PALTA SET
                SUBGRUPO = ?,
                PRODUCTO = ?,
                MATERIA_ACTIVA = ?,
                NECESIDADXHA = ?,
    ...
    def delete(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            query = "DELETE FROM MATERIA_DORGANICA_PALTA WHERE ID = ?"
...
class OrgResumenMateriaOrganicaCVView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM MATERIA_ORGANICA_PALTA_CV p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO MATERIA_ORGANICA_PALTA_CV 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('MATERIA_ORGANICA_PALTA_CV')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE MATERIA_ORGANICA_PALTA_CV 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM MATERIA_ORGANICA_PALTA_CV WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class OrgDetalleMateriaOrganicaCVView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT d.ID, d.IDMATERIA_ORGANICA, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       d.SUBGRUPO, d.PRODUCTO, d.MATERIA_ACTIVA, d.NECESIDADXHA, 
                       d.UND, d.PRECIO_LTKG, d.PRECIO_HA, d.OBSERVACIONES, d.FECHA_CREACION
                FROM MATERIA_DORGANICA_PALTA_CV d
                WHERE d.ID = ?
                """
                cursor.execute(query, [id])
                ...
                SELECT d.ID, d.IDMATERIA_ORGANICA, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       ...
                       p.NOMBRE as PLAN_FERTILIZACION
                FROM MATERIA_DORGANICA_PALTA_CV d
                INNER JOIN MATERIA_ORGANICA_PALTA_CV p ON d.IDMATERIA_ORGANICA = p.ID
                ORDER BY d.FECHA_CREACION DESC
                """
                cursor.execute(query)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            # Preparar la consulta SQL para insertar el nuevo producto
            query = """
            INSERT INTO MATERIA_DORGANICA_PALTA_CV (
                IDMATERIA_ORGANICA, IDPRODUCTO, IDSUBGRUPO, 
                SUBGRUPO, PRODUCTO, MATERIA_ACTIVA, 
                NECESIDADXHA, UND, PRECIO_LTKG, 
                PRECIO_HA, OBSERVACIONES, FECHA_CREACION
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Verificar que el producto existe
            cursor.execute("SELECT COUNT(*) FROM MATERIA_DORGANICA_PALTA_CV WHERE ID = ?", [id])
            if cursor.fetchone()[0] == 0:
                cursor.close()
                return JsonResponse({
                    'status': 'error',
            ...
            # Preparar la consulta SQL para actualizar el producto
            query = """
            UPDATE MATERIA_DORGANICA_PALTA_CV SET
                SUBGRUPO = ?,
                PRODUCTO = ?,
                MATERIA_ACTIVA = ?,
                NECESIDADXHA = ?,
    ...
    def delete(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Preparar la consulta SQL para eliminar el producto
            query = "DELETE FROM MATERIA_DORGANICA_PALTA_CV WHERE ID = ?"
...
class OrgResumenMateriaOrganicaAJSView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM MATERIA_ORGANICA_PALTA_AJS p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO MATERIA_ORGANICA_PALTA_AJS 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('MATERIA_ORGANICA_PALTA_AJS')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE MATERIA_ORGANICA_PALTA_AJS 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM MATERIA_ORGANICA_AJS WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class OrgDetalleMateriaOrganicaAJSView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT d.ID, d.IDMATERIA_ORGANICA, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       d.SUBGRUPO, d.PRODUCTO, d.MATERIA_ACTIVA, d.NECESIDADXHA, 
                       d.UND, d.PRECIO_LTKG, d.PRECIO_HA, d.OBSERVACIONES, d.FECHA_CREACION
                FROM MATERIA_DORGANICA_PALTA_AJS d
                WHERE d.ID = ?
                """
                cursor.execute(query, [id])
                ...
                SELECT d.ID, d.IDMATERIA_ORGANICA, d.IDPRODUCTO, d.IDSUBGRUPO, 
                       ...
                       p.NOMBRE as PLAN_FERTILIZACION
                FROM MATERIA_DORGANICA_PALTA_AJS d
                INNER JOIN MATERIA_ORGANICA_PALTA_AJS p ON d.IDMATERIA_ORGANICA = p.ID
                ORDER BY d.FECHA_CREACION DESC
                """
                cursor.execute(query)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            # Preparar la consulta SQL para insertar el nuevo producto
            query = """
            INSERT INTO MATERIA_DORGANICA_PALTA_AJS (
                IDMATERIA_ORGANICA, IDPRODUCTO, IDSUBGRUPO, 
                SUBGRUPO, PRODUCTO, MATERIA_ACTIVA, 
                NECESIDADXHA, UND, PRECIO_LTKG, 
                PRECIO_HA, OBSERVACIONES, FECHA_CREACION
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Verificar que el producto existe
            cursor.execute("SELECT COUNT(*) FROM MATERIA_DORGANICA_PALTA_AJS WHERE ID = ?", [id])
            if cursor.fetchone()[0] == 0:
                cursor.close()
                return JsonResponse({
                    'status': 'error',
            ...
            # Preparar la consulta SQL para actualizar el producto
            query = """
            UPDATE MATERIA_DORGANICA_PALTA_AJS SET
                SUBGRUPO = ?,
                PRODUCTO = ?,
                MATERIA_ACTIVA = ?,
                NECESIDADXHA = ?,
    ...
    def delete(self, request, id, *args, **kwargs):
        ...
        try:
            ...
            # Preparar la consulta SQL para eliminar el producto
            query = "DELETE FROM MATERIA_DORGANICA_PALTA_AJS WHERE ID = ?"
...
class ResumenMaterialAgricolaView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM PRODUCTO_AGRICOLA_PALTA p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO PRODUCTO_AGRICOLA_PALTA 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('PRODUCTO_AGRICOLA_PALTA')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE PRODUCTO_AGRICOLA_PALTA 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM PRODUCTO_AGRICOLA_PALTA WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class SuministroAgricolaListView(View):
    """GET: lista por PRODUCTO_AGRICOLA_PALTA. POST: inserta fila en SUMINISTRO_AGRICOLA_PALTA."""
        ...
        try:
            ...
            query = """
                SELECT
                    ...
                    s.diciembre_precio
                FROM SUMINISTRO_AGRICOLA_PALTA s
    ...
    def post(self, request, *args, **kwargs):
        ...
        sql = f'INSERT INTO SUMINISTRO_AGRICOLA_PALTA ({cols}) OUTPUT INSERTED.id AS inserted_id VALUES ({placeholders})'
...
class SuministroAgricolaDetailView(View):
    """GET/PUT/DELETE de una fila de SUMINISTRO_AGRICOLA_PALTA por PK id."""
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        sql = 'UPDATE SUMINISTRO_AGRICOLA_PALTA SET ' + ', '.join(sets) + ' WHERE id = ?'
        try:
            cursor = connection_portalaei.cursor()
            cursor.execute(sql, values)
            if cursor.rowcount == 0:
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            cursor = connection_portalaei.cursor()
            cursor.execute('DELETE FROM SUMINISTRO_AGRICOLA_PALTA WHERE id = ?', [id])
            if cursor.rowcount == 0:
                cursor.close()
                return JsonResponse({'status': 'error', 'message': 'No encontrado'}, status=404)
            connection_portalaei.commit()
...
class ResumenMaterialAgricolaCVView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM PRODUCTO_AGRICOLA_PALTA_CV p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO PRODUCTO_AGRICOLA_PALTA_CV 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('PRODUCTO_AGRICOLA_PALTA_CV')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE PRODUCTO_AGRICOLA_PALTA_CV 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM PRODUCTO_AGRICOLA_PALTA_CV WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class SuministroAgricolaListCVView(View):
    """GET: lista por PRODUCTO_AGRICOLA_PALTA_CV. POST: inserta fila en SUMINISTRO_AGRICOLA_PALTA_CV."""
        ...
        try:
            ...
            query = """
                SELECT
                    ...
                    s.diciembre_cantidad,
                    s.diciembre_precio
                FROM SUMINISTRO_AGRICOLA_PALTA_CV s
                WHERE s.IDPRODUCTO_AGRICOLA = ?
                ORDER BY s.id
            """
            cursor.execute(query, [id_pa_int])
    ...
    def post(self, request, *args, **kwargs):
        ...
        placeholders = ', '.join(['?'] * (4 + 12 * 2 + 3))
        # OUTPUT INSERTED.id evita un segundo execute en el mismo cursor (pyodbc / ODBC a veces falla con @@IDENTITY).
        sql = f'INSERT INTO SUMINISTRO_AGRICOLA_PALTA_CV ({cols}) OUTPUT INSERTED.id AS inserted_id VALUES ({placeholders})'
...
class SuministroAgricolaDetailCVView(View):
    """GET/PUT/DELETE de una fila de SUMINISTRO_AGRICOLA_PALTA_CV por PK id."""
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        sql = 'UPDATE SUMINISTRO_AGRICOLA_PALTA_CV SET ' + ', '.join(sets) + ' WHERE id = ?'
        try:
            cursor = connection_portalaei.cursor()
            cursor.execute(sql, values)
            if cursor.rowcount == 0:
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            cursor = connection_portalaei.cursor()
            cursor.execute('DELETE FROM SUMINISTRO_AGRICOLA_PALTA_CV WHERE id = ?', [id])
            if cursor.rowcount == 0:
                cursor.close()
                return JsonResponse({'status': 'error', 'message': 'No encontrado'}, status=404)
            connection_portalaei.commit()
...
class ResumenMaterialAgricolaAJSView(View):
        ...
        try:
            ...
            if id:
                ...
                SELECT p.ID, p.IDUSUARIO, p.IDVARIEDAD, p.IDFASE, p.IDLOTE, p.NOMBRE, 
                       ...
                       CONCAT(lv.SECTOR, ' - ', lv.LOTE, ' - ', lv.CONDICION, ' (', lv.AREA_TOTAL, ' ha)') as LOTE_INFO,
                       lv.SECTOR, lv.LOTE as LOTE_NOMBRE, lv.CONDICION, lv.AREA_TOTAL
                FROM PRODUCTO_AGRICOLA_PALTA_AJS p
                INNER JOIN user_user u ON p.IDUSUARIO = u.id
                INNER JOIN VARIEDAD v ON p.IDVARIEDAD = v.ID
                INNER JOIN FACECULTIVO f ON p.IDFASE = f.ID
                LEFT JOIN LOTES_VARIEDAD lv ON p.IDLOTE = lv.ID
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            query = """
            INSERT INTO PRODUCTO_AGRICOLA_PALTA_AJS 
            (IDUSUARIO, IDVARIEDAD, IDFASE, IDLOTE, NOMBRE, FECHA_INICIO, FECHA_FIN, DESCRIPCION, ID_CAMPANIA) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
            ...
            cursor.execute("SELECT IDENT_CURRENT('PRODUCTO_AGRICOLA_PALTA_AJS')")
            id_insertado = cursor.fetchone()[0]
    ...
    def put(self, request, id, *args, **kwargs):
        try:
            ...
            query = """
            UPDATE PRODUCTO_AGRICOLA_PALTA_AJS 
            SET IDUSUARIO = ?, IDVARIEDAD = ?, IDFASE = ?, IDLOTE = ?, NOMBRE = ?, 
                FECHA_INICIO = ?, FECHA_FIN = ?, DESCRIPCION = ?, ID_CAMPANIA = ?
            WHERE ID = ?
            """
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            ...
            cursor.execute("DELETE FROM PRODUCTO_AGRICOLA_PALTA_AJS WHERE ID = ?", [id])
            connection_portalaei.commit()
...
class SuministroAgricolaListAJSView(View):
    """GET: lista por PRODUCTO_AGRICOLA_PALTA_AJS. POST: inserta fila en SUMINISTRO_AGRICOLA_PALTA_AJS."""
        ...
        try:
            ...
            query = """
                SELECT
                    ...
                    s.diciembre_cantidad,
                    s.diciembre_precio
                FROM SUMINISTRO_AGRICOLA_PALTA_AJS s
                WHERE s.IDPRODUCTO_AGRICOLA = ?
                ORDER BY s.id
            """
            cursor.execute(query, [id_pa_int])
    ...
    def post(self, request, *args, **kwargs):
        ...
        placeholders = ', '.join(['?'] * (4 + 12 * 2 + 3))
        # OUTPUT INSERTED.id evita un segundo execute en el mismo cursor (pyodbc / ODBC a veces falla con @@IDENTITY).
        sql = f'INSERT INTO SUMINISTRO_AGRICOLA_PALTA_AJS ({cols}) OUTPUT INSERTED.id AS inserted_id VALUES ({placeholders})'
...
class SuministroAgricolaDetailAJSView(View):
    """GET/PUT/DELETE de una fila de SUMINISTRO_AGRICOLA_PALTA_AJS por PK id."""
    ...
    def put(self, request, id, *args, **kwargs):
        ...
        sql = 'UPDATE SUMINISTRO_AGRICOLA_PALTA_AJS SET ' + ', '.join(sets) + ' WHERE id = ?'
        try:
            cursor = connection_portalaei.cursor()
            cursor.execute(sql, values)
            if cursor.rowcount == 0:
    ...
    def delete(self, request, id, *args, **kwargs):
        try:
            cursor = connection_portalaei.cursor()
            cursor.execute('DELETE FROM SUMINISTRO_AGRICOLA_PALTA_AJS WHERE id = ?', [id])
            if cursor.rowcount == 0:
                cursor.close()
                return JsonResponse({'status': 'error', 'message': 'No encontrado'}, status=404)
            connection_portalaei.commit()
