...
class evaluacion_desempeño(TemplateView):
    permission_required = 'modulo_gerencia_produccion' 
    template_name = 'GERENCIA_PRODUCCION/pages/rrhh_evaluacion_desempeño.html'
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Ejecutar el procedimiento almacenado con el área 4 hardcodeada
                cursor.execute("EXEC SP_RESUMEN_RRHH_OBJETIVOS @id_area=?, @periodo=?", [21, periodo])
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if objetivo_id:
                ...
                cursor.execute("EXEC RRHH_EV_OBJETIVOS_MEJORA 21")
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if competencia_id:
                ...
                # Si no hay ID, ejecutar el procedimiento para todos con el id_area 21
                cursor.execute("EXEC RRHH_EV_COMPETENCIAS_MEJORA 21")
        ...
        try:
            ...
            if id_evaluacion:
                ...
                if id_area:
                    ...
                    cursor.execute("EXEC SP_FASE_INTERMEDIA_EVALUACIONES @id_area=?, @periodo=?", [21, periodo])
