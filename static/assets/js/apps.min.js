  ...
  handleSidebarMenu = function () {
    ...
    $(".sidebar .nav > .has-sub > a").click(function () {
      ...
      0 === $(".page-sidebar-minified").length &&
        ...
        $(a).is(":visible")
          ? $(a).closest("li").addClass("closing").removeClass("expand")
          : $(a).closest("li").addClass("expanding").removeClass("closed"),
        $(a).slideToggle(e, function () {
    ...
    $(".sidebar").bind("click touchstart", function (a) {
      ...
      $(document).bind("click touchstart", function (a) {
        0 === $(a.target).closest(".sidebar").length && (e = !1),
          0 !== $(a.target).closest("#float-sub-menu").length && (e = !0),
    ...
    function a() {
      $(".tab-overflow").each(function () {
        ...
        $(t)
          ...
          (function (e, a) {
            var t = "li.active";
            $(e).find("li").first().hasClass("nav-item") &&
              (t = $(e).find(".nav-item .active").closest("li")),
  ...
  handleToggleNavProfile = function () {
    ...
    $('[data-toggle="nav-profile"]').click(function (a) {
      ...
      var t = $(this).closest("li"),
        ...
        o = "closing";
      $(n).is(":visible")
        ? ($(t).removeClass("active"), $(n).removeClass(o))
        : ($(t).addClass("active"), $(n).addClass(i)),
        $(n).slideToggle(e, function () {
          $(n).is(":visible")
            ? ($(n).addClass("expand"), $(n).removeClass("closed"))
            : ($(n).addClass("closed"), $(n).removeClass("expand")),
            $(n).removeClass(i + " " + o);
        });
    });
  },
  ...
  handleSidebarMinifyFloatMenu = function () {
    $(document).on("click", "#float-sub-menu li.has-sub > a", function (e) {
      var a = $(this).next(".sub-menu"),
        ...
        i = !1;
      $(a).is(":visible")
        ? ($(t).addClass("closing"), (n = !0))
        : ($(t).addClass("expanding"), (i = !0)),
        $(a).slideToggle({
          duration: 250,
          progress: function () {
            ...
            if (
              (n &&
                l > o &&
                ((l = l > o ? o : l),
                $("#float-sub-menu").css({ top: l + "px", bottom: "auto" }),
  ...
  handleAjaxMode = function (e) {
    ...
    function i(t, i, o) {
      ...
      Pace.restart(),
        ...
        $("#page-container").hasClass("page-sidebar-toggled") &&
          $("#page-container").removeClass("page-sidebar-toggled"),
        (s = '#sidebar [data-toggle="ajax"][href="' + t + '"]'),
        0 !== $(s).length &&
          ($("#sidebar li").removeClass("active"),
          $(s).closest("li").addClass("active"),
          $(s).parents().addClass("active")),
        CLEAR_OPTION &&
          (App.clearPageOption(CLEAR_OPTION), (CLEAR_OPTION = "")),
        o ||
          ((l = t.replace("#", "")),
          (r = window.navigator.userAgent.indexOf("MSIE ")) && r > 0 && r < 9
      ...
      i &&
        ((u = $(i).attr("data-type") ? $(i).attr("data-type") : u),
        (targetDataDataType = $(i).attr("data-data-type")
          ? $(i).attr("data-data-type")
          : u)),
        $.ajax({
          url: c,
          type: h,
