...
//       "/almacen/almacen_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/almacen/almacen_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/almacen/almacen_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/almacen/almacen_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoALCV").on("click", function () {
