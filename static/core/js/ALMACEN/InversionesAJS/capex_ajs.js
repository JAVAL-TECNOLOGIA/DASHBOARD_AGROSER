...
function initCapexTable() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    $("#capexTable").DataTable().ajax.url("/almacen/almacen_capex_ajs/?year=" + yearVal).load();
    return;
  }
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/almacen/almacen_capex_ajs/?year=" + currentYear).load(function () {
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "almacen/almacen_capex_ajs");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/almacen/almacen_capex_ajs/" + formId + "/"
        : "/almacen/almacen_capex_ajs/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/almacen/almacen_capex_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
