...
function initCapexTable() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    $("#capexTable").DataTable().ajax.url("/almacen/almacen_capex_cv/?year=" + yearVal).load();
    return;
  }
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/almacen/almacen_capex_cv/?year=" + currentYear).load(function () {
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "almacen/almacen_capex_cv");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/almacen/almacen_capex_cv/" + formId + "/"
        : "/almacen/almacen_capex_cv/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/almacen/almacen_capex_cv/" + id + "/",
    type: "GET",
    success: function (data) {
