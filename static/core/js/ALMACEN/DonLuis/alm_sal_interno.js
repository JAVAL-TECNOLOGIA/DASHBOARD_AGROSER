...
function abrirModalDetallesSalida(idIngresosAlidaAlm) {
  ...
  $.ajax({
    url: `/almacen/salida-interna/${idIngresosAlidaAlm}/`,
    type: "GET",
    dataType: "json",
...
function mostrarRequerimientos() {
  ...
  const url = construirUrlConFiltros(
    "/almacen/api/buscar_requerimiento/",
    filtros
  );
...
async function obtenerDatosCompletosRequerimiento(idReqInterno) {
  try {
    ...
    const url = `/almacen/api/buscar_requerimiento/?idreqinterno=${idReqInterno}&limit=1`;
...
function cargarDetallesRequerimiento(idReqInterno) {
  ...
  const url = `/almacen/api/detalle-requerimiento/${idReqInterno}/`;
...
function enviarEstructuraAApiReqInterno(
  ...
  const endpoint = "/almacen/api/procesar-requerimiento/";
...
function procesarContabilizacionYCentralizacion(
  ...
  // Llamar al endpoint de contabilización y centralización
  $.ajax({
    url: "/almacen/salida-interna-procesar/",
    type: "POST",
    data: JSON.stringify(datosEnvio),
    contentType: "application/json",
    headers: {
...
function buscarResponsablePorId(idResponsable) {
  ...
  $.ajax({
    url: `/almacen/api/responsables/?idresponsable=${idResponsable}`,
    type: "GET",
    dataType: "json",
    success: function (response) {
...
function buscarCodigoEnAPI(codigo) {
  ...
  $.ajax({
    url: `/almacen/api/responsables/?idresponsable=${codigoFormateado}`,
    type: "GET",
    dataType: "json",
    success: function (response) {
      if (response.success && response.data && response.data.length > 0) {
...
function buscarEnAPIPorNombre(termino) {
  $.ajax({
    url: `/almacen/api/responsables/?nombre=${encodeURIComponent(termino)}`,
    type: "GET",
    dataType: "json",
    success: function (response) {
      if (response.success && response.data && response.data.length > 0) {
...
function obtenerTipoCambioPorFecha(fecha) {
  ...
  $.ajax({
    url: "/almacen/api/tcambio/?fecha=" + encodeURIComponent(fecha),
    method: "GET",
    dataType: "json",
    success: function (response) {
...
function CrearPdfSalidaInterna(id_salida){
  ...
  // Construir URL de la API
  const apiUrl = `/almacen/api/salida-interna/${id_salida}/`;
