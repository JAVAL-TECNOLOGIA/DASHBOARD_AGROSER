...
//       "/costos/costo_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/costos/costo_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/costos/costo_sueldo_mensual/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/costos/costo_salario_mensual/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoCO").on("click", function () {
