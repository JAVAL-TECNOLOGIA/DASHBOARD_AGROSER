...
function inicializarTablaEvaluacionesIntermedio() {
    tablaEvaluacionesIntermedio = $("#tablaEvaluaciones_intermedio").DataTable({
        ...
        // Configuración Ajax
        ajax: {
            url: '/rrhh/api/fase-intermedia/', // URL base fija
            type: 'GET',
            data: function(d) {
...
function renderAcciones(data,type,row){
    return `<div class="btn-group" role="group">
        ...
        <button type="button" class="btn btn-info btn-xs" onclick="EmailManagerCostos.generarEnviarPDFEvaluacion(${row.id_evaluacion})" title="Ver Detalles">
...
function cargarDatosSeguimientoAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/rrhh/api/fase-intermedia/?id_area=6&campania=${periodo}`,
        type: 'GET',
        dataType: 'json',
