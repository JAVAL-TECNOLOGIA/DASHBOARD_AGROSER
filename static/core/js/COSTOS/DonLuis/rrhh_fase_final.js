...
$(document).ready(function() {
    console.log("Inicializando Fase Final - COSTOS...");
...
function cargarDatosSeguimientoAvanceFinal(id_evaluacion) {
    ...
    $.ajax({
        url: `/rrhh/api/fase-final/?id_area=6&campania=${periodo}`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            console.log('Response cargarDatosSeguimientoAvanceFinal /costos/api/fase-final/');
