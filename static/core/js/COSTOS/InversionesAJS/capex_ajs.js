...
function initCapexTable() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    $("#capexTable").DataTable().ajax.url("/costos/costos_capex_ajs/?year=" + yearVal).load();
    return;
  }
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/costos/costos_capex_ajs/?year=" + currentYear).load(function () {
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "costos/costos_capex_ajs");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/costos/costos_capex_ajs/" + formId + "/"
        : "/costos/costos_capex_ajs/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/costos/costos_capex_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
