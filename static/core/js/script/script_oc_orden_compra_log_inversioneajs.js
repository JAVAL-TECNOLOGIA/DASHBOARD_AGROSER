function returnApproveOrders(){
    table_show = $("#tableOCinversioneajs").DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'excelHtml5', 
                title: 'REPORTES DE ORDENES DE COMPRA - INVERSIONES AJS',
        ...
        fixedColumns: true,
        ajax : {
            url: '/order_oc_log_inversioneajs_script/',
            dataSrc: "",
        },
        searching: false,
        lengthChange: false,
