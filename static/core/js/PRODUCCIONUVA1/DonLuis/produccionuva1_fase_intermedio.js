...
function inicializarTablaEvaluacionesIntermedio() {
    ...
    var urlAjax = '/api/fase-intermedia/?id_area=13&campania=' + periodo;
    tablaEvaluacionesIntermedio = $("#tablaEvaluaciones_intermedio").DataTable({
        ...
        ajax: {
            url: '/produccionuva1/api/fase-intermedia/?id_area=13',
            type: 'GET',
                    ...
                    return `
                        <div class="btn-group" role="group">
                            ...
                            <button type="button" class="btn btn-info btn-xs" 
                                    onclick="EmailManagerUva1.generarEnviarPDFEvaluacion(${row.id_evaluacion})" 
                                    title="Ver Detalles">
...
function cargarDatosSeguimientoAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/produccionuva1/api/fase-intermedia/`,
        type: 'GET',
        dataType: 'json',
        ...
        error: function(xhr, status, error) {
            ...
            mostrarMensaje('Error de conexión al cargar datos - prueba', 'error');
        }
    });
