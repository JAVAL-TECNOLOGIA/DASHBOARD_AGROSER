...
--  - /contabilidad/contabilidad_combustibles-lubricantes/     (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_utiles-oficina/               (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_equipos-computo/              (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_otros-suministros/            (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_material-construccion/        (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_repuestos-accesorios/         (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_equipos-uit/                  (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_materiales-agricultura/       (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_equipos-proteccion/           (GET, POST, PUT, DELETE)
-- =====================================================================================================================================================
-- FILTRO POR CAMPAÑA:
...
// =====================================================================================
// Estas funciones obtienen los totales desde el endpoint contabilidad_suministros_totals_dl
...
function calcularTotalPresupuesto() {
  ...
  return new Promise((resolve, reject) => {
    $.ajax({
      url: `/contabilidad/contabilidad_suministros_totals_dl/?year=${yearVal}`,
      type: "GET",
      dataType: "json",
...
function initPresupuestoMateriales() {
  ...
  if ($.fn.DataTable.isDataTable("#materialOficinaTable")) {
    $("#materialOficinaTable").DataTable().ajax.url("/contabilidad/contabilidad_combustibles-lubricantes/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialOficinaTable").DataTable({
    ...
    // ---------------------------------------------------------------------------------
    ajax: {
      url: "/contabilidad/contabilidad_combustibles-lubricantes/?year=" + yearVal,
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm").on("submit", function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_combustibles-lubricantes/" + formId + "/"
        : "/contabilidad/contabilidad_combustibles-lubricantes/",
...
function initPresupuestoUtilesOficina() {
  ...
  if ($.fn.DataTable.isDataTable("#utilesOficinaTable")) {
    $("#utilesOficinaTable").DataTable().ajax.url("/contabilidad/contabilidad_utiles-oficina/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#utilesOficinaTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_utiles-oficina/",
      dataSrc: "data",
    },
    columns: [
  ...
  $("#registerMaterialForm_utiles").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_utiles-oficina/" + formId + "/"
        : "/contabilidad/contabilidad_utiles-oficina/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposComputo() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoComputoTable")) {
    $("#equipoComputoTable").DataTable().ajax.url("/contabilidad/contabilidad_equipos-computo/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoComputoTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_equipos-computo/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_computo").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_equipos-computo/" + formId + "/"
        : "/contabilidad/contabilidad_equipos-computo/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoOtrosSuministros() {
  ...
  if ($.fn.DataTable.isDataTable("#otrosSuministrosTable")) {
    $("#otrosSuministrosTable").DataTable().ajax.url("/contabilidad/contabilidad_otros-suministros/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#otrosSuministrosTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_otros-suministros/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_otros").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_otros-suministros/" + formId + "/"
        : "/contabilidad/contabilidad_otros-suministros/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialConstruccion() {
  ...
  if ($.fn.DataTable.isDataTable("#materialConstruccionTable")) {
    $("#materialConstruccionTable").DataTable().ajax.url("/contabilidad/contabilidad_material-construccion/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialConstruccionTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_material-construccion/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_construccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_material-construccion/" + formId + "/"
        : "/contabilidad/contabilidad_material-construccion/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoRepuestosAccesorios() {
  ...
  if ($.fn.DataTable.isDataTable("#repuestosAccesoriosTable")) {
    $("#repuestosAccesoriosTable").DataTable().ajax.url("/contabilidad/contabilidad_repuestos-accesorios/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#repuestosAccesoriosTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_repuestos-accesorios/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", title: "ID", visible: false },
  ...
  $("#registerMaterialForm_repuestos").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_repuestos-accesorios/" + formId + "/"
        : "/contabilidad/contabilidad_repuestos-accesorios/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposUIT() {
  ...
  if ($.fn.DataTable.isDataTable("#equiposuitTable")) {
    $("#equiposuitTable").DataTable().ajax.url("/contabilidad/contabilidad_equipos-uit/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equiposuitTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_equipos-uit/?year=" +yearVal,
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_uit").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_equipos-uit/" + formId + "/"
        : "/contabilidad/contabilidad_equipos-uit/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialAgricultura() {
  ...
  if ($.fn.DataTable.isDataTable("#materialagriculturaTable")) {
    $("#materialagriculturaTable").DataTable().ajax.url("/contabilidad/contabilidad_materiales-agricultura/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialagriculturaTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_materiales-agricultura/?year=" + yearVal,
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#registerMaterialForm_agricultura").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_materiales-agricultura/" + formId + "/"
        : "/contabilidad/contabilidad_materiales-agricultura/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposProteccion() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoProteccionTable")) {
    $("#equipoProteccionTable").DataTable().ajax.url("/contabilidad/contabilidad_equipos-proteccion/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoProteccionTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_equipos-proteccion/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_proteccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_equipos-proteccion/" + formId + "/"
        : "/contabilidad/contabilidad_equipos-proteccion/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_utiles(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_utiles-oficina/" + id + "/",
    type: "GET",
    success: function (data) {
...
function editarProducto_MaterialOficina(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_combustibles-lubricantes/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_computo(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_equipos-computo/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_otros_suministros(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_otros-suministros/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_construccion(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_material-construccion/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_repuestos(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_repuestos-accesorios/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_uit(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_equipos-uit/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_agricultura(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_materiales-agricultura/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_proteccion(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_equipos-proteccion/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
