...
//       "/contabilidad/contabilidad_sueldo_mensual_ajs/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/contabilidad/contabilidad_salario_mensual_ajs/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
 try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/contabilidad/contabilidad_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/contabilidad/contabilidad_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoCTCV").on("click", function () {
