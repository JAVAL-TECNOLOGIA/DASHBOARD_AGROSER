...
--  - /contabilidad/contabilidad_combustibles-lubricantes_ajs/     (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_utiles-oficina_ajs/               (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_equipos-computo_ajs/              (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_otros-suministros_ajs/            (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_material-construccion_ajs/        (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_repuestos-accesorios_ajs/         (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_equipos-uit_ajs/                  (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_materiales-agricultura_ajs/       (GET, POST, PUT, DELETE)
--  - /contabilidad/contabilidad_equipos-proteccion_ajs/           (GET, POST, PUT, DELETE)
-- =====================================================================================================================================================
-- FILTRO POR CAMPAÑA:
...
// =====================================================================================
// Estas funciones obtienen los totales desde el endpoint contabilidad_suministros_totals_ajs
...
function calcularTotalPresupuesto() {
  ...
  return new Promise((resolve, reject) => {
    $.ajax({
      url: `/contabilidad/contabilidad_suministros_totals_ajs/?year=${yearVal}`,
      type: "GET",
      dataType: "json",
...
function initPresupuestoMateriales() {
  ...
  if ($.fn.DataTable.isDataTable("#materialOficinaTable")) {
    $("#materialOficinaTable").DataTable().ajax.url("/contabilidad/contabilidad_combustibles-lubricantes_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialOficinaTable").DataTable({
    ...
    // ---------------------------------------------------------------------------------
    ajax: {
      url: "/contabilidad/contabilidad_combustibles-lubricantes_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
  ...
  $("#materialOficinaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_material(id, "contabilidad/contabilidad_combustibles-lubricantes_ajs");
  });
  ...
  $("#registerMaterialForm").on("submit", function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_combustibles-lubricantes_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_combustibles-lubricantes_ajs/",
...
function initPresupuestoUtilesOficina() {
  ...
  if ($.fn.DataTable.isDataTable("#utilesOficinaTable")) {
    $("#utilesOficinaTable").DataTable().ajax.url("/contabilidad/contabilidad_utiles-oficina_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#utilesOficinaTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_utiles-oficina_ajs/",
      dataSrc: "data",
    },
    columns: [
  ...
  $("#utilesOficinaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_utiles(id, "contabilidad/contabilidad_utiles-oficina_ajs");
  });
  ...
  $("#registerMaterialForm_utiles").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_utiles-oficina_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_utiles-oficina_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposComputo() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoComputoTable")) {
    $("#equipoComputoTable").DataTable().ajax.url("/contabilidad/contabilidad_equipos-computo_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoComputoTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_equipos-computo_ajs/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#equipoComputoTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_computo(id, "contabilidad/contabilidad_equipos-computo_ajs");
  });
  ...
  $("#registerMaterialForm_computo").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_equipos-computo_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_equipos-computo_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoOtrosSuministros() {
  ...
  if ($.fn.DataTable.isDataTable("#otrosSuministrosTable")) {
    $("#otrosSuministrosTable").DataTable().ajax.url("/contabilidad/contabilidad_otros-suministros_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#otrosSuministrosTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_otros-suministros_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#otrosSuministrosTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_otros_suministros(id, "contabilidad/contabilidad_otros-suministros_ajs");
  });
  ...
  $("#registerMaterialForm_otros").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_otros-suministros_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_otros-suministros_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialConstruccion() {
  ...
  if ($.fn.DataTable.isDataTable("#materialConstruccionTable")) {
    $("#materialConstruccionTable").DataTable().ajax.url("/contabilidad/contabilidad_material-construccion_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialConstruccionTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_material-construccion_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#materialConstruccionTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_construccion(id, "contabilidad/contabilidad_material-construccion_ajs");
  });
  ...
  $("#registerMaterialForm_construccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_material-construccion_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_material-construccion_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoRepuestosAccesorios() {
  ...
  if ($.fn.DataTable.isDataTable("#repuestosAccesoriosTable")) {
    $("#repuestosAccesoriosTable").DataTable().ajax.url("/contabilidad/contabilidad_repuestos-accesorios_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#repuestosAccesoriosTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_repuestos-accesorios_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", title: "ID", visible: false },
  ...
  $("#repuestosAccesoriosTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_accesorios(id, "contabilidad/contabilidad_repuestos-accesorios_ajs");
  });
  ...
  $("#registerMaterialForm_repuestos").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_repuestos-accesorios_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_repuestos-accesorios_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposUIT() {
  ...
  if ($.fn.DataTable.isDataTable("#equiposuitTable")) {
    $("#equiposuitTable").DataTable().ajax.url("/contabilidad/contabilidad_equipos-uit_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equiposuitTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_equipos-uit_ajs/?year=" +yearVal,
      dataSrc: "data",
    },
  ...
  $("#equiposuitTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_uit(id, "contabilidad/contabilidad_equipos-uit_ajs");
  });
  ...
  $("#registerMaterialForm_uit").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_equipos-uit_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_equipos-uit_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialAgricultura() {
  ...
  if ($.fn.DataTable.isDataTable("#materialagriculturaTable")) {
    $("#materialagriculturaTable").DataTable().ajax.url("/contabilidad/contabilidad_materiales-agricultura_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialagriculturaTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_materiales-agricultura_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#materialagriculturaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_agricultura(id, "contabilidad/contabilidad_materiales-agricultura_ajs");
  });
  ...
  $("#registerMaterialForm_agricultura").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_materiales-agricultura_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_materiales-agricultura_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposProteccion() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoProteccionTable")) {
    $("#equipoProteccionTable").DataTable().ajax.url("/contabilidad/contabilidad_equipos-proteccion_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoProteccionTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_equipos-proteccion_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#equipoProteccionTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_proteccion(id, "contabilidad/contabilidad_equipos-proteccion_ajs");
  });
  ...
  $("#registerMaterialForm_proteccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_equipos-proteccion_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_equipos-proteccion_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_utiles(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_utiles-oficina_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
...
function editarProducto_MaterialOficina(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_combustibles-lubricantes_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_computo(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_equipos-computo_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_otros_suministros(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_otros-suministros_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_construccion(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_material-construccion_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_repuestos(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_repuestos-accesorios_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_uit(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_equipos-uit_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_agricultura(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_materiales-agricultura_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_proteccion(id) {
  $.ajax({
    url: "/contabilidad/contabilidad_equipos-proteccion_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
