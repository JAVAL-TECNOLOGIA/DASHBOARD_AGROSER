...
function initCapexTable() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    $("#capexTable").DataTable().ajax.url("/contabilidad/contabilidad_capex_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#capexTable").DataTable({
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/contabilidad/contabilidad_capex_ajs/?year=" + currentYear).load(function () {
    ...
    ajax: {
      url: "/contabilidad/contabilidad_capex_ajs/",
      dataSrc: "data",
    },
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "contabilidad/contabilidad_capex_ajs");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/contabilidad/contabilidad_capex_ajs/" + formId + "/"
        : "/contabilidad/contabilidad_capex_ajs/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/contabilidad/contabilidad_capex_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
