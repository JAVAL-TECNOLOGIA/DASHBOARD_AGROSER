...
//       "/contabilidad/contabilidad_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/contabilidad/contabilidad_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/contabilidad/contabilidad_sueldo_mensual/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/contabilidad/contabilidad_salario_mensual/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoCT").on("click", function () {
