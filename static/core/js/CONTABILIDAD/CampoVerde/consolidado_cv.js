...
//       "/contabilidad/contabilidad_sueldo_mensual_cv/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/contabilidad/contabilidad_salario_mensual_cv/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
 try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/contabilidad/contabilidad_sueldo_mensual_cv/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/contabilidad/contabilidad_salario_mensual_cv/?year=${year}`,
      5,
      2000
    );
