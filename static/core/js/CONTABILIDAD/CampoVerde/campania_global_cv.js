...
// 1) Agrega ?year=... a todo $.ajax GET de /contabilidad/
// 2) Agrega ID_CAMPANIA al body de todo $.ajax POST de /contabilidad/
$.ajaxPrefilter(function (options, originalOptions, jqXHR) {
  if (!options.url) return;
  if (!options.url.startsWith("/contabilidad/")) return;
