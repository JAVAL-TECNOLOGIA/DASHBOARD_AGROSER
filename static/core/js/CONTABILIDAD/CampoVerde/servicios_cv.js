...
function initServiciosTable() {
  var table = $("#serviciosTable").DataTable({
    ...
    ajax: {
      url: "/contabilidad/contabilidad_servicios_cv/",
      dataSrc: "data",
    },
   ...
   */
    ...
    footerCallback: function (row, data, start, end, display) {
      ...
      // Cargar los totales desde la API
      $.ajax({
        url: "/contabilidad/contabilidad_servicios_totals_cv/",
        type: "GET",
        success: function (response) {
          const meses = [
            "Enero",
...
$(document).on("click", ".eliminar-servicio", function () {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.ajax({
        url: `/contabilidad/contabilidad_servicios_cv/${id}/`,
        type: "DELETE",
        success: function (response) {
...
$("#registerMaterialForm_servicios").submit(function (e) {
  ...
  const ajaxConfig = {
    url: isEdit
      ? `/contabilidad/contabilidad_servicios_cv/${id}/`
      : "/contabilidad/contabilidad_servicios_cv/",
