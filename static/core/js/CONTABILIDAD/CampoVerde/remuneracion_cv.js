if (typeof window.presupuestoMaterialesInitialized === "undefined") {
  ...
  function actualizarTotalSueldos() {
    $.ajax({
      url: "/contabilidad/contabilidad_sueldo_mensual_cv/",
      type: "GET",
      dataType: "json",
  ...
  function actualizarTotalSalarios() {
    $.ajax({
      url: "/contabilidad/contabilidad_salario_mensual_cv/",
      type: "GET",
      dataType: "json",
      success: function (response) {
        const totalAnual = response.data.find(
  ...
  function initPresupuestoSueldos() {
    obtenerTasaCargaSocial().then(function () {
      table = $("#sueldosTable").DataTable({
        ...
        ajax: {
          url: "/contabilidad/contabilidad_sueldos_cv/",
          dataSrc: "data",
        },
        columns: [
    ...
    $("#formSueldoSalario")
      ...
      .on("submit", function (e) {
        ...
        $.ajax({
          url: isUpdate
            ? `/contabilidad/contabilidad_sueldos_cv/${formId}/`
            : "/contabilidad/contabilidad_sueldos_cv/",
  ...
  function initPresupuestoSalarios() {
    obtenerTasaCargaSocial_salarios().then(function () {
      tableSalarios = $("#salariosTable").DataTable({
        ...
        ajax: {
          url: "/contabilidad/contabilidad_salarios_cv/",
          dataSrc: "data",
        },
        columns: [
          { data: "id", title: "ID", visible: false },
    ...
    $("#formSalario")
      ...
      .on("submit", function (e) {
        ...
        $.ajax({
          url: isUpdate
            ? `/contabilidad/contabilidad_salarios_cv/${formId}/`
            : "/contabilidad/contabilidad_salarios_cv/",
          type: isUpdate ? "PUT" : "POST",
          contentType: "application/json",
          data: JSON.stringify(jsonData),
          success: function (response) {
  ...
  function eliminarSueldo(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: `/contabilidad/contabilidad_sueldos_cv/${id}/`,
          type: "DELETE",
          success: function (response) {
            if (response.status === "success") {
  ...
  function eliminarSalario(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: `/contabilidad/contabilidad_salarios_cv/${id}/`,
          type: "DELETE",
          success: function (response) {
            if (response.status === "success") {
              Swal.fire("¡Eliminado!", response.message, "success");
