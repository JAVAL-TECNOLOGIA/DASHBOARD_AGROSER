...
$(document).ready(function() {
    ...
    $('#filtroCampaniaDesempeno').on('change', function() {
        if (tablaEvaluacionesIntermedio) {
            ...
            var nuevaUrl = '/contabilidad/api/fase-intermedia/?id_area=1&campania=' + periodo;
    ...
    tablaEvaluacionesIntermedio = $("#tablaEvaluaciones_intermedio").DataTable({
        ...
        ajax: {
            url: function() {
                ...
                // Extraer solo el año si viene en formato CAMP2025
                periodo = periodo.startsWith('CAMP') ? periodo.replace('CAMP', '') : periodo;
                return '/contabilidad/api/fase-intermedia/?id_area=1&campania=' + periodo;
            },
            type: 'GET',
                    ...
                    return `
                        <div class="btn-group" role="group">
                            ...
                            <button type="button" class="btn btn-info btn-xs" 
                                    onclick="EmailManagerConta.generarEnviarPDFEvaluacion(${row.id_evaluacion})" 
                                    title="Ver Detalles">
...
function cargarDatosSeguimientoAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/fase-intermedia/`,
        type: 'GET',
        dataType: 'json',
