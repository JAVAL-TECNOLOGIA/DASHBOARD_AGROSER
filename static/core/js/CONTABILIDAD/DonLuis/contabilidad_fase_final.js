// Funciones para la Fase Final de Evaluaciones - CONTABILIDAD
$(document).ready(function() {
    console.log("Inicializando Fase Final - CONTABILIDAD...");
    ...
    $('#filtroCampaniaDesempeno').on('change', function() {
        if (tablaEvaluacionesFinal) {
            ...
            // Recargar la tabla usando ajax.reload() y pasando el parámetro dinámico
            tablaEvaluacionesFinal.ajax.reload(null, false); 
        }
    });
...
function inicializarTablaEvaluacionesFinal() {
    tablaEvaluacionesFinal = $("#tablaEvaluaciones_final").DataTable({
        ...
        ajax: {
            url: '/contabilidad/api/fase-final/',
            type: 'GET',
            data: function(d) {
                const campaniaSeleccionada = $('#filtroCampaniaDesempeno').val();
                const campania = campaniaSeleccionada ? campaniaSeleccionada.replace('CAMP', '') : new Date().getFullYear();
                d.id_area = 1;
                d.campania = campania;
            },
...
function cargarDatosSeguimientoAvanceFinal(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/fase-final/?id_area=1&campania=${periodo}`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            console.log('Response cargarDatosSeguimientoAvanceFinal /contabilidad/api/fase-final/');
...
function cargarComentariosExistentesFinal(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/detalles-evaluacion-final/?id_evaluacion=${id_evaluacion}&cargar_comentarios=true`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaObjetivosAvanceFinal(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/detalles-evaluacion-final/?id_evaluacion=${id_evaluacion}&tipo=1`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaCompetenciasAvanceFinal(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/detalles-evaluacion-final/?id_evaluacion=${id_evaluacion}&tipo=2`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function actualizarAvancesFinalEnServidor(tipo, actualizaciones, tipoNombre, callback, comentarios = {}) {
    ...
    $.ajax({
        url: '/contabilidad/api/detalles-evaluacion-final/',
        type: 'PUT',
...
const EmailManagerFinal = {
  ...
  config: {
    endpoints: {
      evaluaciones: "/contabilidad/objetivos_evaluacion/",
      detallesObjetivos: "/contabilidad/detalles_objetivos/",
    },
    scripts: {
      competenciasPaths: [
      ...
      $.ajax({
        ...
        success: function (responseUsuarios) {
          ...
          const continuarFlujo = () => {
            $.ajax({
              url: "/contabilidad/detalles_objetivos/",
              type: "GET",
              dataType: "json",
              success: function (responseObjetivos) {
                ...
                $.ajax({
                  url: "/contabilidad/detalles_competencias/",
                  type: "GET",
                  dataType: "json",
