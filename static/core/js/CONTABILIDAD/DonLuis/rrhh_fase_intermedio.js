...
function inicializarTablaEvaluacionesIntermedio() {
    tablaEvaluacionesIntermedio = $("#tablaEvaluaciones_intermedio").DataTable({
        ...
        ajax: {
            url: '/contabilidad/api/fase-intermedia/?id_area=1',
            type: 'GET',
...
function cargarComentariosExistentes(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&cargar_comentarios=true`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaObjetivosAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=1`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaCompetenciasAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/contabilidad/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=2`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function actualizarAvancesEnServidor(tipo, actualizaciones, tipoNombre, callback, comentarios = {}) {
    ...
    $.ajax({
        url: '/contabilidad/api/detalles-evaluacion/',
        type: 'PUT',
