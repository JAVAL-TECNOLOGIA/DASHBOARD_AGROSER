...
function calcularTotalPresupuesto_Capex() {
  $.ajax({
    url: "/legal/legal_capex_totals_cv/",
    type: "GET",
    dataType: "json",
    success: function (data) {
...
function initCapexTable() {
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "legal/legal_capex_cv");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/legal/legal_capex_cv/" + formId + "/"
        : "/legal/legal_capex_cv/",
