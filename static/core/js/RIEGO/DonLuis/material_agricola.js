...
function AGRICOLAAGRICOLAiniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#AGRICOLAAGRICOLAtablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/riego/api/materia_agricola_dl/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function AGRICOLAguardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/riego/api/materia_agricola_dl/${idregistro}/`
      : "/riego/api/materia_agricola_dl/";
...
function AGRICOLAeditarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/riego/api/materia_agricola_dl/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAcargarProductosPrograma_AC(idPrograma) {
  ...
  $("#AGRICOLAtablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url:
        "/riego/api/suministro_agricola/?id_producto_agricola=" +
...
function AGRICOLAeditarProductoAutumnCrisp(idSuministro) {
  $.ajax({
    url: "/riego/api/suministro_agricola/" + encodeURIComponent(idSuministro) + "/",
    type: "GET",
    success: function (response) {
      if (!response || !response.data) {
...
function AGRICOLAeliminarProductoAutumnCrisp(idProducto) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: `/riego/api/suministro_agricola/${idProducto}/`,
        type: "DELETE",
        success: function (response) {
...
function AGRICOLAeliminarFertilizacion(idRegistro) {
  ...
  $.ajax({
    url: `/riego/api/suministro_agricola/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAguardarProductoAutumnCrisp() {
  ...
  var url = "/riego/api/suministro_agricola/";
  var metodo = "POST";
  if (esEdicion) {
    url = "/riego/api/suministro_agricola/" + encodeURIComponent(suministroPk) + "/";
    metodo = "PUT";
  }
