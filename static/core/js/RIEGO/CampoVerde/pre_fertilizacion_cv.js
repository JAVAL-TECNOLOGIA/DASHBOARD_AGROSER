...
function iniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#tablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/riego/api/riego_presupuesto_fertilizacion_cv/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function guardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/riego/api/riego_presupuesto_fertilizacion_cv/${idregistro}/`
      : "/riego/api/riego_presupuesto_fertilizacion_cv/";
...
function editarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/riego/api/riego_presupuesto_fertilizacion_cv/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function cargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#tablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/riego/api/riego_dprefertilizacion_cv/`,
      type: "GET",
      dataSrc: function (json) {
...
function guardarProductoAutumnCrisp() {
  ...
  let url = "/riego/api/riego_dprefertilizacion_cv/";
  let tipo = "POST";

  if (idProducto) {
    url = `/riego/api/riego_dprefertilizacion_cv/${idProducto}/`;
    tipo = "PUT";
  }
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/riego/api/riego_dprefertilizacion_cv/${productoId}/`;
    metodo = "PUT";
  } else {
  }
