...
--  - /riego/riego_combustibles-lubricantes_ajs/     (GET, POST, PUT, DELETE)
--  - /riego/riego_utiles-oficina_ajs/               (GET, POST, PUT, DELETE)
--  - /riego/riego_equipos-computo_ajs/              (GET, POST, PUT, DELETE)
--  - /riego/riego_otros-suministros_ajs/            (GET, POST, PUT, DELETE)
--  - /riego/riego_material-construccion_ajs/        (GET, POST, PUT, DELETE)
--  - /riego/riego_repuestos-accesorios_ajs/         (GET, POST, PUT, DELETE)
--  - /riego/riego_equipos-uit_ajs/                  (GET, POST, PUT, DELETE)
--  - /riego/riego_materiales-agricultura_ajs/       (GET, POST, PUT, DELETE)
--  - /riego/riego_equipos-proteccion_ajs/           (GET, POST, PUT, DELETE)
-- =====================================================================================================================================================
-- FILTRO POR CAMPAÑA:
...
// =====================================================================================
// Estas funciones obtienen los totales desde el endpoint riego_suministros_totals_ajs
...
function calcularTotalPresupuesto() {
  ...
  return new Promise((resolve, reject) => {
    $.ajax({
      url: `/riego/riego_suministros_totals_ajs/?year=${yearVal}`,
      type: "GET",
      dataType: "json",
...
function initPresupuestoMateriales() {
  ...
  if ($.fn.DataTable.isDataTable("#materialOficinaTable")) {
    $("#materialOficinaTable").DataTable().ajax.url("/riego/riego_combustibles-lubricantes_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialOficinaTable").DataTable({
    ...
    // ---------------------------------------------------------------------------------
    ajax: {
      url: "/riego/riego_combustibles-lubricantes_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
  ...
  $("#materialOficinaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_material(id, "riego/riego_combustibles-lubricantes_ajs");
  });
  ...
  $("#registerMaterialForm").on("submit", function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_combustibles-lubricantes_ajs/" + formId + "/"
        : "/riego/riego_combustibles-lubricantes_ajs/",
...
function initPresupuestoUtilesOficina() {
  ...
  if ($.fn.DataTable.isDataTable("#utilesOficinaTable")) {
    $("#utilesOficinaTable").DataTable().ajax.url("/riego/riego_utiles-oficina_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#utilesOficinaTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_utiles-oficina_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
  ...
  $("#utilesOficinaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_utiles(id, "riego/riego_utiles-oficina_ajs");
  });
  ...
  $("#registerMaterialForm_utiles").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_utiles-oficina_ajs/" + formId + "/"
        : "/riego/riego_utiles-oficina_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposComputo() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoComputoTable")) {
    $("#equipoComputoTable").DataTable().ajax.url("/riego/riego_equipos-computo_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoComputoTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_equipos-computo_ajs/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#equipoComputoTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_computo(id, "riego/riego_equipos-computo_ajs");
  });
  ...
  $("#registerMaterialForm_computo").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_equipos-computo_ajs/" + formId + "/"
        : "/riego/riego_equipos-computo_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoOtrosSuministros() {
  ...
  if ($.fn.DataTable.isDataTable("#otrosSuministrosTable")) {
    $("#otrosSuministrosTable").DataTable().ajax.url("/riego/riego_otros-suministros_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#otrosSuministrosTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_otros-suministros_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#otrosSuministrosTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_otros_suministros(id, "riego/riego_otros-suministros_ajs");
  });
  ...
  $("#registerMaterialForm_otros").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_otros-suministros_ajs/" + formId + "/"
        : "/riego/riego_otros-suministros_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialConstruccion() {
  ...
  if ($.fn.DataTable.isDataTable("#materialConstruccionTable")) {
    $("#materialConstruccionTable").DataTable().ajax.url("/riego/riego_material-construccion_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialConstruccionTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_material-construccion_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#materialConstruccionTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_construccion(id, "riego/riego_material-construccion_ajs");
  });
  ...
  $("#registerMaterialForm_construccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_material-construccion_ajs/" + formId + "/"
        : "/riego/riego_material-construccion_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoRepuestosAccesorios() {
  ...
  if ($.fn.DataTable.isDataTable("#repuestosAccesoriosTable")) {
    $("#repuestosAccesoriosTable").DataTable().ajax.url("/riego/riego_repuestos-accesorios_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#repuestosAccesoriosTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_repuestos-accesorios_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", title: "ID", visible: false },
  ...
  $("#repuestosAccesoriosTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_accesorios(id, "riego/riego_repuestos-accesorios_ajs");
  });
  ...
  $("#registerMaterialForm_repuestos").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_repuestos-accesorios_ajs/" + formId + "/"
        : "/riego/riego_repuestos-accesorios_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposUIT() {
  ...
  if ($.fn.DataTable.isDataTable("#equiposuitTable")) {
    $("#equiposuitTable").DataTable().ajax.url("/riego/riego_equipos-uit_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equiposuitTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_equipos-uit_ajs/?year=" +yearVal,
      dataSrc: "data",
    },
  ...
  $("#equiposuitTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_uit(id, "riego/riego_equipos-uit_ajs");
  });
  ...
  $("#registerMaterialForm_uit").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_equipos-uit_ajs/" + formId + "/"
        : "/riego/riego_equipos-uit_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialAgricultura() {
  ...
  if ($.fn.DataTable.isDataTable("#materialagriculturaTable")) {
    $("#materialagriculturaTable").DataTable().ajax.url("/riego/riego_materiales-agricultura_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialagriculturaTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_materiales-agricultura_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#materialagriculturaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_agricultura(id, "riego/riego_materiales-agricultura_ajs");
  });
  ...
  $("#registerMaterialForm_agricultura").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_materiales-agricultura_ajs/" + formId + "/"
        : "/riego/riego_materiales-agricultura_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposProteccion() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoProteccionTable")) {
    $("#equipoProteccionTable").DataTable().ajax.url("/riego/riego_equipos-proteccion_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoProteccionTable").DataTable({
    ...
    ajax: {
      url: "/riego/riego_equipos-proteccion_ajs/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#equipoProteccionTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_proteccion(id, "riego/riego_equipos-proteccion_ajs");
  });
  ...
  $("#registerMaterialForm_proteccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riego/riego_equipos-proteccion_ajs/" + formId + "/"
        : "/riego/riego_equipos-proteccion_ajs/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_utiles(id) {
  $.ajax({
    url: "/riego/riego_utiles-oficina_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
...
function editarProducto_MaterialOficina(id) {
  $.ajax({
    url: "/riego/riego_combustibles-lubricantes_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_computo(id) {
  $.ajax({
    url: "/riego/riego_equipos-computo_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_otros_suministros(id) {
  $.ajax({
    url: "/riego/riego_otros-suministros_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_construccion(id) {
  $.ajax({
    url: "/riego/riego_material-construccion_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_repuestos(id) {
  $.ajax({
    url: "/riego/riego_repuestos-accesorios_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_uit(id) {
  $.ajax({
    url: "/riego/riego_equipos-uit_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_agricultura(id) {
  $.ajax({
    url: "/riego/riego_materiales-agricultura_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_proteccion(id) {
  $.ajax({
    url: "/riego/riego_equipos-proteccion_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
