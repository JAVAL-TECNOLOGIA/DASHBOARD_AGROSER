...
function initCapexTable() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    $("#capexTable").DataTable().ajax.url("/calidad/calidad_capex_cv/?year=" + yearVal).load();
    return;
  }
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/calidad/calidad_capex_cv/?year=" + currentYear).load(function () {
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "calidad/calidad_capex_cv");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/calidad/calidad_capex_cv/" + formId + "/"
        : "/calidad/calidad_capex_cv/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/calidad/calidad_capex_cv/" + id + "/",
    type: "GET",
    success: function (data) {
