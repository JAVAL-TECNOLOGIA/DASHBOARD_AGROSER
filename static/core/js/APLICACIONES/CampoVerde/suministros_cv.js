...
--  - /aplicaciones/aplicaciones_combustibles-lubricantes_cv/     (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_utiles-oficina_cv/               (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_equipos-computo_cv/              (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_otros-suministros_cv/            (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_material-construccion_cv/        (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_repuestos-accesorios_cv/         (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_equipos-uit_cv/                  (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_materiales-agricultura_cv/       (GET, POST, PUT, DELETE)
--  - /aplicaciones/aplicaciones_equipos-proteccion_cv/           (GET, POST, PUT, DELETE)
-- =====================================================================================================================================================
-- FILTRO POR CAMPAÑA:
...
// =====================================================================================
// Estas funciones obtienen los totales desde el endpoint aplicaciones_suministros_totals_cv
...
function calcularTotalPresupuesto() {
  ...
  return new Promise((resolve, reject) => {
    $.ajax({
      url: `/aplicaciones/aplicaciones_suministros_totals_cv/?year=${yearVal}`,
      type: "GET",
      dataType: "json",
...
function initPresupuestoMateriales() {
  ...
  if ($.fn.DataTable.isDataTable("#materialOficinaTable")) {
    $("#materialOficinaTable").DataTable().ajax.url("/aplicaciones/aplicaciones_combustibles-lubricantes_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialOficinaTable").DataTable({
    ...
    // ---------------------------------------------------------------------------------
    ajax: {
      url: "/aplicaciones/aplicaciones_combustibles-lubricantes_cv/?year=" + yearVal,
      dataSrc: "data",
    },
  ...
  $("#materialOficinaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_material(id, "aplicaciones/aplicaciones_combustibles-lubricantes_cv");
  });
  ...
  $("#registerMaterialForm").on("submit", function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_combustibles-lubricantes_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_combustibles-lubricantes_cv/",
...
function initPresupuestoUtilesOficina() {
  ...
  if ($.fn.DataTable.isDataTable("#utilesOficinaTable")) {
    $("#utilesOficinaTable").DataTable().ajax.url("/aplicaciones/aplicaciones_utiles-oficina_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#utilesOficinaTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_utiles-oficina_cv/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
  ...
  $("#utilesOficinaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_utiles(id, "aplicaciones/aplicaciones_utiles-oficina_cv");
  });
  ...
  $("#registerMaterialForm_utiles").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_utiles-oficina_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_utiles-oficina_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposComputo() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoComputoTable")) {
    $("#equipoComputoTable").DataTable().ajax.url("/aplicaciones/aplicaciones_equipos-computo_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoComputoTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_equipos-computo_cv/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#equipoComputoTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_computo(id, "aplicaciones/aplicaciones_equipos-computo_cv");
  });
  ...
  $("#registerMaterialForm_computo").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_equipos-computo_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_equipos-computo_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoOtrosSuministros() {
  ...
  if ($.fn.DataTable.isDataTable("#otrosSuministrosTable")) {
    $("#otrosSuministrosTable").DataTable().ajax.url("/aplicaciones/aplicaciones_otros-suministros_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#otrosSuministrosTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_otros-suministros_cv/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#otrosSuministrosTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_otros_suministros(id, "aplicaciones/aplicaciones_otros-suministros_cv");
  });
  ...
  $("#registerMaterialForm_otros").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_otros-suministros_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_otros-suministros_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialConstruccion() {
  ...
  if ($.fn.DataTable.isDataTable("#materialConstruccionTable")) {
    $("#materialConstruccionTable").DataTable().ajax.url("/aplicaciones/aplicaciones_material-construccion_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialConstruccionTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_material-construccion_cv/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#materialConstruccionTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_construccion(id, "aplicaciones/aplicaciones_material-construccion_cv");
  });
  ...
  $("#registerMaterialForm_construccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_material-construccion_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_material-construccion_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoRepuestosAccesorios() {
  ...
  if ($.fn.DataTable.isDataTable("#repuestosAccesoriosTable")) {
    $("#repuestosAccesoriosTable").DataTable().ajax.url("/aplicaciones/aplicaciones_repuestos-accesorios_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#repuestosAccesoriosTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_repuestos-accesorios_cv/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", title: "ID", visible: false },
  ...
  $("#repuestosAccesoriosTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_accesorios(id, "aplicaciones/aplicaciones_repuestos-accesorios_cv");
  });
  ...
  $("#registerMaterialForm_repuestos").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_repuestos-accesorios_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_repuestos-accesorios_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposUIT() {
  ...
  if ($.fn.DataTable.isDataTable("#equiposuitTable")) {
    $("#equiposuitTable").DataTable().ajax.url("/aplicaciones/aplicaciones_equipos-uit_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equiposuitTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_equipos-uit_cv/?year=" +yearVal,
      dataSrc: "data",
    },
  ...
  $("#equiposuitTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_uit(id, "aplicaciones/aplicaciones_equipos-uit_cv");
  });
  ...
  $("#registerMaterialForm_uit").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_equipos-uit_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_equipos-uit_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialAgricultura() {
  ...
  if ($.fn.DataTable.isDataTable("#materialagriculturaTable")) {
    $("#materialagriculturaTable").DataTable().ajax.url("/aplicaciones/aplicaciones_materiales-agricultura_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#materialagriculturaTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_materiales-agricultura_cv/?year=" + yearVal,
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#materialagriculturaTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_agricultura(id, "aplicaciones/aplicaciones_materiales-agricultura_cv");
  });
  ...
  $("#registerMaterialForm_agricultura").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_materiales-agricultura_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_materiales-agricultura_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposProteccion() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoProteccionTable")) {
    $("#equipoProteccionTable").DataTable().ajax.url("/aplicaciones/aplicaciones_equipos-proteccion_cv/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#equipoProteccionTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_equipos-proteccion_cv/?year=" + yearVal,
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#equipoProteccionTable tbody").on("click", ".delete-btn", function () {
    var id = $(this).data("id");
    eliminarProducto_proteccion(id, "aplicaciones/aplicaciones_equipos-proteccion_cv");
  });
  ...
  $("#registerMaterialForm_proteccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_equipos-proteccion_cv/" + formId + "/"
        : "/aplicaciones/aplicaciones_equipos-proteccion_cv/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_utiles(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_utiles-oficina_cv/" + id + "/",
    type: "GET",
    success: function (data) {
...
function editarProducto_MaterialOficina(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_combustibles-lubricantes_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_computo(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_equipos-computo_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_otros_suministros(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_otros-suministros_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_construccion(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_material-construccion_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_repuestos(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_repuestos-accesorios_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_uit(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_equipos-uit_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_agricultura(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_materiales-agricultura_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_proteccion(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_equipos-proteccion_cv/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
