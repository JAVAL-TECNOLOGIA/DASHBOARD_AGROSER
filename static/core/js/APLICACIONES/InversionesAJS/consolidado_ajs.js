...
//       "/aplicaciones/aplicaciones_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/aplicaciones/aplicaciones_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/aplicaciones/aplicaciones_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/aplicaciones/aplicaciones_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoAPCV").on("click", function () {
