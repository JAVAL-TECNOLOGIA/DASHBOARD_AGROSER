      ...
      if (programa.ID) {
        try {
          ...
          const response = await $.ajax({
            url: `/aplicaciones/programas_ajs/${programa.ID}/detalles/`,
            type: "GET",
            dataType: "json",
          });
...
function initTablaProgramasPlantines_SG() {
  const tabla = $("#tablaPrograma_plantines_SG").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/programas_ajs/",
      type: "GET",
      data: function (d) {
        d.idfase = 1;
        d.idvariedad = 1;
...
function guardarProgramaFitosanitario() {
  ...
  $.ajax({
    url: modoEdicion
      ? `/aplicaciones/programas_ajs/${idPrograma}/`
      : "/aplicaciones/programas_ajs/",
  ...
  setTimeout(() => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          url: `/aplicaciones/programas_ajs/detalles/${idPrograma}/`,
          type: "DELETE",
          success: function (response) {
...
function eliminarPrograma(idPrograma) {
  ...
  $.ajax({
    url: `/aplicaciones/programas_ajs/${idPrograma}/`,
    type: "DELETE",
    success: function (response) {
      // Cerrar el modal de carga y eliminar cualquier residuo en el DOM
      Swal.close();
...
function obtenerProductosPrograma(idPrograma) {
  $.ajax({
    url: `/aplicaciones/programas_ajs/${idPrograma}/detalles/`,
    type: "GET",
...
function guardarProducto() {
  ...
  const ajaxConfig = {
    url: esEdicion
      ? `/aplicaciones/programas_ajs/detalles/${idProducto}/`
      : "/aplicaciones/programas_ajs/detalles/",
...
Esta acción no se puede deshacer.`;
  ...
  if (confirm(mensajeConfirmacion)) {
    ...
    $.ajax({
      url: `/aplicaciones/programas_ajs/detalles/${idProducto}/`,
      type: "DELETE",
      success: function (response) {
        if (response.status === "success") {
