...
function calcularTotalPresupuesto_Capex() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    ...
    // Actualizar todos los widgets que muestran el totala
...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/aplicaciones/aplicaciones_capex/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate ? "/aplicaciones/aplicaciones_capex/" + formId + "/" : "/aplicaciones/aplicaciones_capex/",
 ...
 */
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/aplicaciones/aplicaciones_capex/" + formId + "/"
        : "/aplicaciones/aplicaciones_capex/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_capex(id) {
  $.ajax({
    url: "/aplicaciones/aplicaciones_capex/" + id + "/",
    type: "GET",
    success: function (data) {
