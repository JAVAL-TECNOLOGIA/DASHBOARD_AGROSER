...
const EmailManager = {
  ...
  config: {
    ...
    scripts: {
      competenciasPaths: [
        "/static/core/js/aplicaciones/DonLuis/rrhh_ev_competencias.js",
        
      ],
    },
    messages: {
      confirmation: {
        title: "Confirmación - Aplicaciones",
        text: "¿Desea generar el PDF de esta evaluación y enviarlo por correo desde el módulo de Aplicaciones?",
        confirmButtonText: "Sí, generar y enviar",
        cancelButtonText: "Cancelar",
      },
      loading: {
        title: "Procesando - Aplicaciones",
        text: "Generando PDF desde Aplicaciones y preparando envío...",
      },
      errors: {
        invalidId: "No se pudo identificar la evaluación en Aplicaciones ",
    ...
    metadata: {
      ...
      version: "1.0.0",
      descripcion:
        "Gestión de correos para evaluaciones de objetivos - Aplicaciones",
    },
  },
