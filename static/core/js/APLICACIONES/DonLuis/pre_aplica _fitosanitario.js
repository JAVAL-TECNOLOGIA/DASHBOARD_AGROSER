      ...
      if (programa.ID) {
        try {
          ...
          const response = await $.ajax({
            url: `/aplicaciones/programas/${programa.ID}/detalles/`,
            type: "GET",
            dataType: "json",
          });
...
function guardarProgramaFitosanitario() {
  ...
  $.ajax({
    url: modoEdicion
      ? `/aplicaciones/programas/${idPrograma}/`
  ...
  setTimeout(() => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          url: `/aplicaciones/programas/detalles/${idPrograma}/`,
          type: "DELETE",
          success: function (response) {
...
function eliminarPrograma(idPrograma) {
  ...
  $.ajax({
    url: `/aplicaciones/programas/${idPrograma}/`,
    type: "DELETE",
    success: function (response) {
      // Cerrar el modal de carga y eliminar cualquier residuo en el DOM
      Swal.close();
...
function obtenerProductosPrograma(idPrograma) {
  $.ajax({
    url: `/aplicaciones/programas/${idPrograma}/detalles/`,
    type: "GET",
...
function guardarProducto() {
  ...
  const ajaxConfig = {
    url: esEdicion
      ? `/aplicaciones/programas/detalles/${idProducto}/`
      : "/aplicaciones/programas/detalles/",
...
Esta acción no se puede deshacer.`;
  ...
  if (confirm(mensajeConfirmacion)) {
    ...
    $.ajax({
      url: `/aplicaciones/programas/detalles/${idProducto}/`,
      type: "DELETE",
      success: function (response) {
        if (response.status === "success") {
