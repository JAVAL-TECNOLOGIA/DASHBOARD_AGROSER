...
function iniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#tablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/riegouva/api/riego_presupuesto_fertilizacion_ajs/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function guardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/riegouva/api/riego_presupuesto_fertilizacion_ajs/${idregistro}/`
      : "/riegouva/api/riego_presupuesto_fertilizacion_ajs/";
...
function editarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/riegouva/api/riego_presupuesto_fertilizacion_ajs/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function cargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#tablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/riegouva/api/riego_dprefertilizacion_ajs/`,
      type: "GET",
      dataSrc: function (json) {
...
function guardarProductoAutumnCrisp() {
  ...
  let url = "/riegouva/api/riego_dprefertilizacion_ajs/";
  let tipo = "POST";

  if (idProducto) {
    url = `/riegouva/api/riego_dprefertilizacion_ajs/${idProducto}/`;
    tipo = "PUT";
  }
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/riegouva/api/riego_dprefertilizacion_ajs/${productoId}/`;
    metodo = "PUT";
  } else {
  }
...
function cargarLotes(idVariedad, selectorId = null, idCampania = null, idEmpresa = null) {
  ...
  return new Promise((resolve, reject) => {
    ...
    $.ajax({
      url: "/riegouva/api/lotes_variedad/",
      type: "GET",
      data: {
        idvariedad: idVariedad,
