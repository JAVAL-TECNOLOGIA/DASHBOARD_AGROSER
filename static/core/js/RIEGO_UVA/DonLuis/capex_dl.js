...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/riegouva/produccionpalta_capex/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate ? "/riegouva/produccionpalta_capex/" + formId + "/" : "/riegouva/produccionpalta_capex/",
 ...
 */
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegouva/produccionpalta_capex/" + formId + "/"
        : "/riegouva/produccionpalta_capex/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_capex(id) {
  $.ajax({
    url: "/riegouva/produccionpalta_capex/" + id + "/",
    type: "GET",
    success: function (data) {
