...
// 1) Agrega ?year=... a todo $.ajax GET de /produccionuva2/
// 2) Agrega ID_CAMPANIA al body de todo $.ajax POST de /produccionuva2/
$.ajaxPrefilter(function (options, originalOptions, jqXHR) {
  if (!options.url) return;
  if (!options.url.startsWith("/produccionuva2/")) return;
