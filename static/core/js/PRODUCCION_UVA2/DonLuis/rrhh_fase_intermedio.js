...
function inicializarTablaEvaluacionesIntermedio() {
    tablaEvaluacionesIntermedio = $("#tablaEvaluaciones_intermedio").DataTable({
        ...
        ajax: {
            url: '/produccionuva2/api/fase-intermedia/?id_area=14',
            type: 'GET',
...
function cargarDatosSeguimientoAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/produccionuva2/api/fase-intermedia/`,
        type: 'GET',
        dataType: 'json',
...
function cargarComentariosExistentes(id_evaluacion) {
    ...
    $.ajax({
        url: `/produccionuva2/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&cargar_comentarios=true`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaObjetivosAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/produccionuva2/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=1`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaCompetenciasAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/produccionuva2/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=2`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function actualizarAvancesEnServidor(tipo, actualizaciones, tipoNombre, callback, comentarios = {}) {
    ...
    $.ajax({
        url: '/produccionuva2/api/detalles-evaluacion/',
        type: 'PUT',
