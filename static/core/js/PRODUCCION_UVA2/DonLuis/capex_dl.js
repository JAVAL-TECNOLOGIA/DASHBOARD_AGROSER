...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/produccionuva2/produccionuva2_capex/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate ? "/produccionuva2/produccionuva2_capex/" + formId + "/" : "/produccionuva2/produccionuva2_capex/",
 ...
 */
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/produccionuva2/produccionuva2_capex/" + formId + "/"
        : "/produccionuva2/produccionuva2_capex/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_capex(id) {
  $.ajax({
    url: "/produccionuva2/produccionuva2_capex/" + id + "/",
    type: "GET",
    success: function (data) {
