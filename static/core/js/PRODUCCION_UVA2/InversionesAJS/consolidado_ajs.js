...
//       "/produccionuva2/produccionuva2_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/produccionuva2/produccionuva2_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/produccionuva2/produccionuva2_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/produccionuva2/produccionuva2_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoPRO2CV").on("click", function () {
