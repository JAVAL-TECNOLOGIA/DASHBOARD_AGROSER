...
//       "/tic_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/tic_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/tic_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/tic_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoTICV").on("click", function () {
