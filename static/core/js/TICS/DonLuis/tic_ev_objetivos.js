...
const EmailManager = {
  ...
  config: {
    ...
    scripts: {
      competenciasPaths: [
        "/static/core/js/TICS/DonLuis/rrhh_ev_competencias.js",
        
      ],
    },
    messages: {
      confirmation: {
        title: "Confirmación - TIC",
        text: "¿Desea generar el PDF de esta evaluación y enviarlo por correo desde el módulo de TIC?",
        confirmButtonText: "Sí, generar y enviar",
        cancelButtonText: "Cancelar",
      },
      loading: {
        title: "Procesando - TIC",
        text: "Generando PDF desde TIC y preparando envío...",
      },
      errors: {
        invalidId: "No se pudo identificar la evaluación en TIC ",
    ...
    metadata: {
      ...
      version: "1.0.0",
      descripcion:
        "Gestión de correos para evaluaciones de objetivos - TIC",
    },
  },
