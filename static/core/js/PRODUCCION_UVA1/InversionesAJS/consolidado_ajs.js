...
//       "/produccionuva1/produccionuva1_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/produccionuva1/produccionuva1_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/produccionuva1/produccionuva1_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/produccionuva1/produccionuva1_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoPROD1CV").on("click", function () {
