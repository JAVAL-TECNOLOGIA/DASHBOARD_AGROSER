...
function iniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#tablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionuva1/api/materia_organica_ajs/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function guardarNuevoPrograma_SG() {
  ...
  const descripcion = $("#descripcion_produccionuva1").val() || "";
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionuva1/api/materia_organica_ajs/${idregistro}/`
      : "/produccionuva1/api/materia_organica_ajs/";
...
function guardarNuevoPrograma_AC() {
  ...
  const descripcion = $("#descripcion_produccionuva1_AC").val() || "";
...
function guardarNuevoPrograma_MC() {
  ...
  const descripcion = $("#descripcion_produccionuva1_MC").val() || "";
...
function guardarNuevoPrograma_SUGRA() {
  ...
  const descripcion = $("#descripcion_produccionuva1_SUGRA").val() || "";
...
function editarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/materia_organica_ajs/${idRegistro}/`,
    type: "GET",
    success: function (response) {
      ...
      $("#descripcion_produccionuva1").val(registro.DESCRIPCION || "");
...
function editarFertilizacion_AC(idRegistro) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Llenar la descripción
      $("#descripcion_produccionuva1_AC").val(registro.DESCRIPCION || "");
...
function cargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#tablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/produccionuva1/api/organica_materia_ajs/`,
      type: "GET",
      dataSrc: function (json) {
...
function guardarProductoAutumnCrisp() {
  ...
  let url = "/produccionuva1/api/organica_materia_ajs/";
  let tipo = "POST";

  if (idProducto) {
    url = `/produccionuva1/api/organica_materia_ajs/${idProducto}/`;
    tipo = "PUT";
  }
...
function editarFertilizacion_MC(idRegistro) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Llenar la descripción
      $("#descripcion_produccionuva1_MC").val(registro.DESCRIPCION || "");
...
function editarFertilizacion_SUGRA(idRegistro) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Llenar la descripción
      $("#descripcion_produccionuva1_SUGRA").val(registro.DESCRIPCION || "");
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/produccionuva1/api/organica_materia_ajs/${productoId}/`;
    metodo = "PUT";
  } else {
  }
