...
function initCapexTable() {
  ...
  if ($.fn.DataTable.isDataTable("#capexTable")) {
    $("#capexTable").DataTable().ajax.url("/produccionuva1/produccionuva1_capex_ajs/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#capexTable").DataTable({
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/produccionuva1/produccionuva1_capex_ajs/?year=" + currentYear).load(function () {
    ...
    ajax: {
      url: "/produccionuva1/produccionuva1_capex_ajs/",
      dataSrc: "data",
    },
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "produccionuva1/produccionuva1_capex_ajs");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/produccionuva1/produccionuva1_capex_ajs/" + formId + "/"
        : "/produccionuva1/produccionuva1_capex_ajs/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/produccionuva1/produccionuva1_capex_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
