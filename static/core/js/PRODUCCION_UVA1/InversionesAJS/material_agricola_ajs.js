...
function AGRICOLAAGRICOLAiniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#AGRICOLAAGRICOLAtablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionuva1/api/materia_agricola_uva1_ajs/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function AGRICOLAguardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionuva1/api/materia_agricola_uva1_ajs/${idregistro}/`
      : "/produccionuva1/api/materia_agricola_uva1_ajs/";
...
function AGRICOLAeditarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/materia_agricola_uva1_ajs/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAcargarProductosPrograma_AC(idPrograma) {
  ...
  $("#AGRICOLAtablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url:
        "/produccionuva1/api/suministro_agricola_uva1_ajs/?id_producto_agricola=" +
...
function AGRICOLAeditarProductoAutumnCrisp(idSuministro) {
  $.ajax({
    url: "/produccionuva1/api/suministro_agricola_uva1_ajs/" + encodeURIComponent(idSuministro) + "/",
    type: "GET",
    success: function (response) {
      if (!response || !response.data) {
...
function AGRICOLAeliminarProductoAutumnCrisp(idProducto) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: `/produccionuva1/api/suministro_agricola_uva1_ajs/${idProducto}/`,
        type: "DELETE",
        success: function (response) {
...
function AGRICOLAeliminarFertilizacion(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/suministro_agricola_uva1_ajs/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAguardarProductoAutumnCrisp() {
  ...
  var url = "/produccionuva1/api/suministro_agricola_uva1_ajs/";
  var metodo = "POST";
  if (esEdicion) {
    url = "/produccionuva1/api/suministro_agricola_uva1_ajs/" + encodeURIComponent(suministroPk) + "/";
    metodo = "PUT";
  }
...
function AGRICOLA_inicializarAutocompleteSuministroSG() {
  ...
  $("#AGRICOLA_descripcion_sum").autocomplete({
    ...
    source: function (request, response) {
      $.ajax({
        url: "/produccionuva1/api_productos_agricolas_uva1/",
        dataType: "json",
        data: { q: request.term },
