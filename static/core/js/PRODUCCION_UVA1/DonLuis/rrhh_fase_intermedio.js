...
//     // Inicializar la tabla cuando el tab se muestra por primera vez
//     $('a[href="#default-tab-2"]').on('shown.bs.tab', function (e) {
//         console.log("Tab Fase Intermedia mostrado");
        
//         if (!tablaIntermedioInicializada) {
//             console.log("Primera vez que se muestra el tab, inicializando tabla...");
            
//             // Verificar que el filtro existe
//             if ($('#filtroCampaniaDesempeno').length > 0) {
//                 var campaniaActual = $('#filtroCampaniaDesempeno').val();
//                 console.log("Campaña actual del filtro:", campaniaActual);
                
//                 inicializarTablaEvaluacionesIntermedio();
//                 tablaIntermedioInicializada = true;
//             } else {
//                 console.error("Filtro de campaña no encontrado!");
//             }
//         } else {
//             // Si ya está inicializada, solo ajustar columnas
//             console.log("Tabla ya inicializada, ajustando columnas...");
...
//     if ($.fn.DataTable.isDataTable("#tablaEvaluaciones_intermedio")) {
//         console.log("Destruyendo tabla existente...");
//         $("#tablaEvaluaciones_intermedio").DataTable().destroy();
//         $("#tablaEvaluaciones_intermedio").empty();
//     }
    
//     // Obtener campaña actual
//     var campaniaActual = $('#filtroCampaniaDesempeno').val();
//     if (!campaniaActual || campaniaActual.trim() === '') {
//         campaniaActual = 'CAMP' + new Date().getFullYear();
//     }
    
//     // Construir URL completa ANTES de inicializar DataTable
//     var urlCompleta = '/rrhh/api/fase-intermedia/?id_area=13&campania=' + campaniaActual;
//     console.log("URL completa para DataTable:", urlCompleta);
...
//         // Configuración para Ajax - usar URL como STRING, no como función
//         ajax: {
//             url: urlCompleta,
//             type: 'GET',
//             dataSrc: function(json) {
//                 console.log("Datos recibidos de la API:", json);
//                 console.log("Status de la respuesta:", json.status);
...
//                 let errorMsg = 'Error de conexión al cargar datos';
...
//                                     onclick="abrirSeguimientoAvance(${row.id_evaluacion})" 
...
//                                     onclick="verDetallesAvance(${row.id_evaluacion})" 
//                                     title="Ver Detalles">
...
//             // Mensaje removido - no mostrar notificación en cada recarga
...
//     $.ajax({
//         url: `/produccionuva1/api/fase-intermedia/?campania=${campania}`,
//         type: 'GET',
//         dataType: 'json',
...
//     $.ajax({
//         url: `/produccionuva1/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&cargar_comentarios=true`,
//         type: 'GET',
//         dataType: 'json',
//         success: function(response) {
...
//     $.ajax({
//         url: `/produccionuva1/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=1`,
//         type: 'GET',
//         dataType: 'json',
//         success: function(response) {
...
//                             <td>
//                                 <div class="progress" style="height: 20px;">
//                                     <div class="progress-bar ${progressClass}" style="width: ${objetivo.porcentaje_actual || 0}%">
...
//     $.ajax({
//         url: `/produccionuva1/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=2`,
//         type: 'GET',
//         dataType: 'json',
//         success: function(response) {
...
//                             <td>
//                                 <div class="progress" style="height: 20px;">
//                                     <div class="progress-bar ${progressClass}" style="width: ${competencia.porcentaje_actual || 0}%">
...
//     $.ajax({
//         url: '/produccionuva1/api/detalles-evaluacion/',
//         type: 'PUT',
