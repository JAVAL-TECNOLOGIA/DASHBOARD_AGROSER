...
function ORGANICAOrganicainiciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#ORGANICAOrganicatablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionuva1/api/materia_organica_dl/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function ORGANICAguardarNuevoPrograma_SG() {
  ...
  const descripcion = $("#ORGANICAdescripcion_produccionuva1").val() || "";
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionuva1/api/materia_organica_dl/${idregistro}/`
      : "/produccionuva1/api/materia_organica_dl/";
...
function ORGANICAguardarNuevoPrograma_AC() {
  ...
  const descripcion = $("#ORGANICAdescripcion_produccionuva1_AC").val() || "";
...
function ORGANICAguardarNuevoPrograma_MC() {
  ...
  const descripcion = $("#ORGANICAdescripcion_produccionuva1_MC").val() || "";
...
function ORGANICAguardarNuevoPrograma_SUGRA() {
  ...
  const descripcion = $("#ORGANICAdescripcion_produccionuva1_SUGRA").val() || "";
...
function ORGANICAeditarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/materia_organica_dl/${idRegistro}/`,
    type: "GET",
    success: function (response) {
      ...
      $("#ORGANICAdescripcion_produccionuva1").val(registro.DESCRIPCION || "");
...
function ORGANICAeditarFertilizacion_AC(idRegistro) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Llenar la descripción
      $("#ORGANICAdescripcion_produccionuva1_AC").val(registro.DESCRIPCION || "");
...
function ORGANICAcargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#ORGANICAtablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/produccionuva1/api/organica_materia/`,
      type: "GET",
      dataSrc: function (json) {
...
function ORGANICAguardarProductoAutumnCrisp() {
  ...
  let url = "/produccionuva1/api/organica_materia/";
  let tipo = "POST";

  if (idProducto) {
    url = `/produccionuva1/api/organica_materia/${idProducto}/`;
    tipo = "PUT";
  }
...
function ORGANICAeditarFertilizacion_MC(idRegistro) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Llenar la descripción
      $("#ORGANICAdescripcion_produccionuva1_MC").val(registro.DESCRIPCION || "");
...
function ORGANICAeditarFertilizacion_SUGRA(idRegistro) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Llenar la descripción
      $("#ORGANICAdescripcion_produccionuva1_SUGRA").val(registro.DESCRIPCION || "");
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/produccionuva1/api/organica_materia/${productoId}/`;
    metodo = "PUT";
  } else {
  }
...
function cargarLotes(idVariedad, selectorId = null, idCampania = null, idEmpresa = null) {
  ...
  return new Promise((resolve, reject) => {
    ...
    $.ajax({
      url: "/produccionuva1/api/lotes_variedad/",
      type: "GET",
      data: {
        idvariedad: idVariedad,
