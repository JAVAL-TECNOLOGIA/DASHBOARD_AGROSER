...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/produccionuva1/produccionuva1_capex/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate ? "/produccionuva1/produccionuva1_capex/" + formId + "/" : "/produccionuva1/produccionuva1_capex/",
 ...
 */
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/produccionuva1/produccionuva1_capex/" + formId + "/"
        : "/produccionuva1/produccionuva1_capex/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_capex(id) {
  $.ajax({
    url: "/produccionuva1/produccionuva1_capex/" + id + "/",
    type: "GET",
    success: function (data) {
