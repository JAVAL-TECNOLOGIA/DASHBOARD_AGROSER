...
function AGRICOLAAGRICOLAiniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#AGRICOLAAGRICOLAtablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionuva1/api/materia_agricola_uva1_cv/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function AGRICOLAguardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionuva1/api/materia_agricola_uva1_cv/${idregistro}/`
      : "/produccionuva1/api/materia_agricola_uva1_cv/";
...
function AGRICOLAeditarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/materia_agricola_uva1_cv/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAcargarProductosPrograma_AC(idPrograma) {
  ...
  $("#AGRICOLAtablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url:
        "/produccionuva1/api/suministro_agricola_uva1_cv/?id_producto_agricola=" +
...
function AGRICOLAeditarProductoAutumnCrisp(idSuministro) {
  $.ajax({
    url: "/produccionuva1/api/suministro_agricola_uva1_cv/" + encodeURIComponent(idSuministro) + "/",
    type: "GET",
    success: function (response) {
      if (!response || !response.data) {
...
function AGRICOLAeliminarProductoAutumnCrisp(idProducto) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: `/produccionuva1/api/suministro_agricola_uva1_cv/${idProducto}/`,
        type: "DELETE",
        success: function (response) {
...
function AGRICOLAeliminarFertilizacion(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/suministro_agricola_uva1_cv/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAguardarProductoAutumnCrisp() {
  ...
  var url = "/produccionuva1/api/suministro_agricola_uva1_cv/";
  var metodo = "POST";
  if (esEdicion) {
    url = "/produccionuva1/api/suministro_agricola_uva1_cv/" + encodeURIComponent(suministroPk) + "/";
    metodo = "PUT";
  }
