...
function iniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#tablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionuva1/api/materia_organica_cv/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function guardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionuva1/api/materia_organica_cv/${idregistro}/`
      : "/produccionuva1/api/materia_organica_cv/";
...
function editarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionuva1/api/materia_organica_cv/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function cargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#tablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/produccionuva1/api/organica_materia_cv/`,
      type: "GET",
      dataSrc: function (json) {
...
function guardarProductoAutumnCrisp() {
  ...
  let url = "/produccionuva1/api/organica_materia_cv/";
  let tipo = "POST";

  if (idProducto) {
    url = `/produccionuva1/api/organica_materia_cv/${idProducto}/`;
    tipo = "PUT";
  }
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/produccionuva1/api/organica_materia_cv/${productoId}/`;
    metodo = "PUT";
  } else {
  }
