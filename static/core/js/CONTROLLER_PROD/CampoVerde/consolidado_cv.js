...
//       "/controller_prod/controller_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/controller_prod/controller_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/controller_prod/controller_sueldo_mensual_cv/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/controller_prod/controller_salario_mensual_cv/?year=${year}`,
      5,
      2000
    );
