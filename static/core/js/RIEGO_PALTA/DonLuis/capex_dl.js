...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_capex/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate ? "/riegopalta/produccionpalta_capex/" + formId + "/" : "/riegopalta/produccionpalta_capex/",
 ...
 */
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_capex/" + formId + "/"
        : "/riegopalta/produccionpalta_capex/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_capex(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_capex/" + id + "/",
    type: "GET",
    success: function (data) {
