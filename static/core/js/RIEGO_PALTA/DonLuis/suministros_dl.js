...
function initPresupuestoMateriales() {
  ...
  var table = $("#materialOficinaTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_combustibles-lubricantes/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm").on("submit", function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_combustibles-lubricantes/" + formId + "/"
        : "/riegopalta/produccionpalta_combustibles-lubricantes/",
...
function initPresupuestoUtilesOficina() {
  ...
  var table = $("#utilesOficinaTable").DataTable({
    ...
    // ajax para obtener los datos de la tabla
    ajax: {
      url: "/riegopalta/produccionpalta_utiles-oficina/",
      dataSrc: "data",
    },
    columns: [
  ...
  $("#registerMaterialForm_utiles").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_utiles-oficina/" + formId + "/"
        : "/riegopalta/produccionpalta_utiles-oficina/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposComputo() {
  var table = $("#equipoComputoTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_equipos-computo/",
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_computo").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_equipos-computo/" + formId + "/"
        : "/riegopalta/produccionpalta_equipos-computo/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoOtrosSuministros() {
  var table = $("#otrosSuministrosTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_otros-suministros/",
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_otros").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_otros-suministros/" + formId + "/"
        : "/riegopalta/produccionpalta_otros-suministros/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialConstruccion() {
  var table = $("#materialConstruccionTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_material-construccion/",
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_construccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_material-construccion/" + formId + "/"
        : "/riegopalta/produccionpalta_material-construccion/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoRepuestosAccesorios() {
  var table = $("#repuestosAccesoriosTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_repuestos-accesorios/",
      dataSrc: "data",
    },
    columns: [
      { data: "id", title: "ID", visible: false },
  ...
  $("#registerMaterialForm_repuestos").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_repuestos-accesorios/" + formId + "/"
        : "/riegopalta/produccionpalta_repuestos-accesorios/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposUIT() {
  var table = $("#equiposuitTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_equipos-uit/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_uit").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_equipos-uit/" + formId + "/"
        : "/riegopalta/produccionpalta_equipos-uit/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialAgricultura() {
  var table = $("#materialagriculturaTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_materiales-agricultura/",
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#registerMaterialForm_agricultura").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_materiales-agricultura/" + formId + "/"
        : "/riegopalta/produccionpalta_materiales-agricultura/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposProteccion() {
  var table = $("#equipoProteccionTable").DataTable({
    ...
    ajax: {
      url: "/riegopalta/produccionpalta_equipos-proteccion/",
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_proteccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/riegopalta/produccionpalta_equipos-proteccion/" + formId + "/"
        : "/riegopalta/produccionpalta_equipos-proteccion/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_utiles(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_utiles-oficina/" + id + "/",
    type: "GET",
    success: function (data) {
...
function editarProducto_MaterialOficina(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_combustibles-lubricantes/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_computo(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_equipos-computo/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_otros_suministros(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_otros-suministros/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_construccion(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_material-construccion/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_repuestos(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_repuestos-accesorios/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_uit(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_equipos-uit/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_agricultura(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_materiales-agricultura/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_proteccion(id) {
  $.ajax({
    url: "/riegopalta/produccionpalta_equipos-proteccion/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function actualizarConsolidadoMateriales() {
  ...
  $.ajax({
    url: `/riegopalta/produccionpalta_suministros_totals_dl/?year=${yearVal}`,
    type: "GET",
    dataType: "json",
    success: function (data) {
...
function initPresupuesto(config) {
  ...
  return function () {
    ...
    const calcularTotalPresupuesto = () => {
      return new Promise((resolve, reject) => {
        $.ajax({
          url: "/riegopalta/produccionpalta_suministros_totals_dl/",
          type: "GET",
          dataType: "json",
          success: function (data) {
            $(totalSelector).text(
