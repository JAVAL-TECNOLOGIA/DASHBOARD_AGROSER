...
function iniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#tablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/riegopalta/api/riego_presupuesto_fertilizacion_cv/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function guardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const datosPrograma = {
      ...
      ID_CAMPANIA: $("#filtroAnioPresupuesto").val()  // 🔥 Aquí
    };
    ...
    const url = esEdicion
      ? `/riegopalta/api/riego_presupuesto_fertilizacion_cv/${idregistro}/`
      : "/riegopalta/api/riego_presupuesto_fertilizacion_cv/";
...
function editarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/riegopalta/api/riego_presupuesto_fertilizacion_cv/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function cargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#tablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/riegopalta/api/riego_dprefertilizacion_cv/`,
      type: "GET",
      dataSrc: function (json) {
...
function guardarProductoAutumnCrisp() {
  ...
  let url = "/riegopalta/api/riego_dprefertilizacion_cv/";
  let tipo = "POST";

  if (idProducto) {
    url = `/riegopalta/api/riego_dprefertilizacion_cv/${idProducto}/`;
    tipo = "PUT";
  }
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/riegopalta/api/riego_dprefertilizacion_cv/${productoId}/`;
    metodo = "PUT";
  } else {
  }
...
function cargarLotes(idVariedad, selectorId = null, idCampania = null, idEmpresa = null) {
  ...
  return new Promise((resolve, reject) => {
    ...
    $.ajax({
      url: "/riegopalta/api/lotes_variedad/",
      type: "GET",
      data: {
        idvariedad: idVariedad,
