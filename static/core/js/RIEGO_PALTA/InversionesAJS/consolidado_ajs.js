...
//       "/riegopalta/produccionpalta_sueldo_mensual/", // Ajusta si la ruta difiere
//       3,
//       2000
//     );
...
//       "/riegopalta/produccionpalta_salario_mensual/", // Ojo con la ruta
//       3,
//       2000
//     );
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/riegopalta/produccionpalta_sueldo_mensual_ajs/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/riegopalta/produccionpalta_salario_mensual_ajs/?year=${year}`,
      5,
      2000
    );
...
$("#recargarTodoCACV").on("click", function () {
