...
function AGRICOLAAGRICOLAiniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#AGRICOLAAGRICOLAtablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionpalta/api/materia_agricola_palta_cv/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function AGRICOLAguardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionpalta/api/materia_agricola_palta_cv/${idregistro}/`
      : "/produccionpalta/api/materia_agricola_palta_cv/";
...
function AGRICOLAeditarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionpalta/api/materia_agricola_palta_cv/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAcargarProductosPrograma_AC(idPrograma) {
  ...
  $("#AGRICOLAtablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url:
        "/produccionpalta/api/suministro_agricola_palta_cv/?id_producto_agricola=" +
...
function editarProductoAutumnCrisp(idSuministro) {
  $.ajax({
    url: "/produccionpalta/api/suministro_agricola_palta_cv/" + encodeURIComponent(idSuministro) + "/",
    type: "GET",
    success: function (response) {
      if (!response || !response.data) {
...
function eliminarProductoAutumnCrisp(idProducto) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: `/produccionpalta/api/suministro_agricola_palta_cv/${idProducto}/`,
        type: "DELETE",
        success: function (response) {
...
function AGRICOLAeliminarFertilizacion(idRegistro) {
  ...
  $.ajax({
    url: `/produccionpalta/api/suministro_agricola_palta_cv/`,
    type: "GET",
    success: function (response) {
...
function AGRICOLAguardarProductoAutumnCrisp() {
  ...
  var url = "/produccionpalta/api/suministro_agricola_palta_cv/";
  var metodo = "POST";
  if (esEdicion) {
    url = "/produccionpalta/api/suministro_agricola_palta_cv/" + encodeURIComponent(suministroPk) + "/";
    metodo = "PUT";
  }
