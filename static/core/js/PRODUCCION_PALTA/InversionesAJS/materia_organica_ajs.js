...
function iniciarTablaResumen_SG(nombrePestaña) {
  ...
  if (nombrePestaña == "PLANTINES") {
    ...
    const tabla = $("#tablaFertilizacionPlantines_SG").DataTable({
      ...
      ajax: {
        url: "/produccionpalta/api/materia_organica_ajs/",
        type: "GET",
        data: function (d) {
          d.idfase = 1;
          d.idvariedad = 1;
...
function guardarNuevoPrograma_SG() {
  ...
  if (!hayErrores) {
    ...
    const url = esEdicion
      ? `/produccionpalta/api/materia_organica_ajs/${idregistro}/`
      : "/produccionpalta/api/materia_organica_ajs/";
...
function editarFertilizacion_SG(idRegistro) {
  ...
  $.ajax({
    url: `/produccionpalta/api/materia_organica_ajs/${idRegistro}/`,
    type: "GET",
    success: function (response) {
...
function cargarProductosPrograma_AC(idPrograma) {
  ...
  const tabla = $("#tablaDetalleProductos_AC").DataTable({
    ...
    ajax: {
      url: `/produccionpalta/api/organica_materia_ajs/`,
      type: "GET",
      dataSrc: function (json) {
...
function guardarProductoAutumnCrisp() {
  ...
  let url = "/produccionpalta/api/organica_materia_ajs/";
  let tipo = "POST";

  if (idProducto) {
    url = `/produccionpalta/api/organica_materia_ajs/${idProducto}/`;
    tipo = "PUT";
  }
...
function guardarProductoSweetGlobe() {
  ...
  if (esEdicion) {
    url = `/produccionpalta/api/organica_materia_ajs/${productoId}/`;
    metodo = "PUT";
  } else {
  }
