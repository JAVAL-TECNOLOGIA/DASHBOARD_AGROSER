$(document).ready(function () {
  // Inicializar la tabla de servicios con el año actual
  initServiciosTable();
...
// ============================================================================
// FUNCION PRINCIPAL: Inicializa la tabla de servicios de terceros
// Recibe el parametro year para filtrar por campaña
// ============================================================================
...
function initServiciosTable() {
  ...
  if ($.fn.DataTable.isDataTable("#serviciosTable")) {
    $("#serviciosTable").DataTable().ajax.url("/rrhh/rrhh_servicios_dl/?year=" + yearVal).load();
    return;
  }
  ...
  var table = $("#serviciosTable").DataTable({
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          ...
          dt.ajax.url("/rrhh/rrhh_servicios_dl/?year=" + currentYear).load(function () {
    ...
    ajax: {
      url: "/rrhh/rrhh_servicios_dl/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    ...
    // ============================================================================
    // FOOTER CALLBACK: Calcula los totales directamente de los datos de la tabla
    // Esto evita llamadas AJAX adicionales y mantiene los totales sincronizados
    // con el filtro de campaña seleccionado
    // ============================================================================
...
function actualizarTotalWidget() {
  ...
  $.ajax({
    url: `/rrhh/rrhh_servicios_totals_dl/?year=${yearVal}`,
    type: "GET",
...
$("#registerMaterialForm_servicios").submit(function (e) {
  ...
  const ajaxConfig = {
    url: isEdit ? `/rrhh/rrhh_servicios_dl/${id}/` : "/rrhh/rrhh_servicios_dl/",
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      meses.forEach((mes) => {
        ...
        $(`#${mes}_cantidad_servicios`).prop("disabled", false);
