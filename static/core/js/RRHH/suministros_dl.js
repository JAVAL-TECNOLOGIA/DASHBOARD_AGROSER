...
function calcularTotalPresupuesto() {
  ...
  return new Promise((resolve, reject) => {
    $.ajax({
      url: `/rrhh/rrhh_suministros_totals_dl/?year=${yearVal}`,
      type: "GET",
      dataType: "json",
...
function initPresupuestoMateriales() {
  ...
  if ($.fn.DataTable.isDataTable("#materialOficinaTable")) {
    $("#materialOficinaTable").DataTable().ajax.url("/rrhh/rrhh_combustibles-lubricantes/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#materialOficinaTable").DataTable({
    ...
    ajax: {
      url: "/rrhh/rrhh_combustibles-lubricantes", //+ yearVal,
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm").on("submit", function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_combustibles-lubricantes/" + formId + "/"
        : "/rrhh/rrhh_combustibles-lubricantes/",
...
function initPresupuestoUtilesOficina() {
  ...
  if ($.fn.DataTable.isDataTable("#utilesOficinaTable")) {
    $("#utilesOficinaTable").DataTable().ajax.url("/rrhh/rrhh_utiles-oficina/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#utilesOficinaTable").DataTable({
    ...
    // Ajax para obtener los datos de la tabla filtrados por campaña
    ajax: {
      url: "/rrhh/rrhh_utiles-oficina/",// + yearVal,
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#registerMaterialForm_utiles").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_utiles-oficina/" + formId + "/"
        : "/rrhh/rrhh_utiles-oficina/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposComputo() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoComputoTable")) {
    $("#equipoComputoTable").DataTable().ajax.url("/rrhh/rrhh_equipos-computo/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#equipoComputoTable").DataTable({
    ...
    // Ajax para obtener los datos de la tabla filtrados por campaña
    ajax: {
      url: "/rrhh/rrhh_equipos-computo/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
  ...
  $("#registerMaterialForm_computo").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_equipos-computo/" + formId + "/"
        : "/rrhh/rrhh_equipos-computo/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoOtrosSuministros() {
  ...
  if ($.fn.DataTable.isDataTable("#otrosSuministrosTable")) {
    $("#otrosSuministrosTable").DataTable().ajax.url("/rrhh/rrhh_otros-suministros/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#otrosSuministrosTable").DataTable({
    ...
    // Ajax para obtener los datos de la tabla filtrados por campaña
    ajax: {
      url: "/rrhh/rrhh_otros-suministros/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_otros").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_otros-suministros/" + formId + "/"
        : "/rrhh/rrhh_otros-suministros/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialConstruccion() {
  ...
  if ($.fn.DataTable.isDataTable("#materialConstruccionTable")) {
    $("#materialConstruccionTable").DataTable().ajax.url("/rrhh/rrhh_material-construccion/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#materialConstruccionTable").DataTable({
    ...
    // Ajax para obtener los datos de la tabla filtrados por campaña
    ajax: {
      url: "/rrhh/rrhh_material-construccion/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_construccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_material-construccion/" + formId + "/"
        : "/rrhh/rrhh_material-construccion/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoRepuestosAccesorios() {
  ...
  if ($.fn.DataTable.isDataTable("#repuestosAccesoriosTable")) {
    $("#repuestosAccesoriosTable").DataTable().ajax.url("/rrhh/rrhh_repuestos-accesorios/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#repuestosAccesoriosTable").DataTable({
    ...
    // Ajax para obtener los datos de la tabla filtrados por campaña
    ajax: {
      url: "/rrhh/rrhh_repuestos-accesorios/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", title: "ID", visible: false },
  ...
  $("#registerMaterialForm_repuestos").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_repuestos-accesorios/" + formId + "/"
        : "/rrhh/rrhh_repuestos-accesorios/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposUIT() {
  ...
  if ($.fn.DataTable.isDataTable("#equiposuitTable")) {
    $("#equiposuitTable").DataTable().ajax.url("/rrhh/rrhh_equipos-uit/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#equiposuitTable").DataTable({
    ...
    ajax: {
      url: "/rrhh/rrhh_equipos-uit/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_uit").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_equipos-uit/" + formId + "/"
        : "/rrhh/rrhh_equipos-uit/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoMaterialAgricultura() {
  ...
  if ($.fn.DataTable.isDataTable("#materialagriculturaTable")) {
    $("#materialagriculturaTable").DataTable().ajax.url("/rrhh/rrhh_materiales-agricultura/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#materialagriculturaTable").DataTable({
    ...
    ajax: {
      url: "/rrhh/rrhh_materiales-agricultura/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    fixedColumns: {
      right: 1, // Fija la última columna (acciones) a la derecha
  ...
  $("#registerMaterialForm_agricultura").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_materiales-agricultura/" + formId + "/"
        : "/rrhh/rrhh_materiales-agricultura/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function initPresupuestoEquiposProteccion() {
  ...
  if ($.fn.DataTable.isDataTable("#equipoProteccionTable")) {
    $("#equipoProteccionTable").DataTable().ajax.url("/rrhh/rrhh_equipos-proteccion/?year=" + CAMPANIA_ACTIVA).load();
    return;
  }
  ...
  var table = $("#equipoProteccionTable").DataTable({
    ...
    ajax: {
      url: "/rrhh/rrhh_equipos-proteccion/?year=" + ($('#filtroAnioPresupuesto').val() || 'CAMP' + new Date().getFullYear()),
      dataSrc: "data",
    },
    columns: [
      { data: "id", visible: false },
  ...
  $("#registerMaterialForm_proteccion").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/rrhh/rrhh_equipos-proteccion/" + formId + "/"
        : "/rrhh/rrhh_equipos-proteccion/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_utiles(id) {
  $.ajax({
    url: "/rrhh/rrhh_utiles-oficina/" + id + "/",
    type: "GET",
    success: function (data) {
...
function editarProducto_MaterialOficina(id) {
  $.ajax({
    url: "/rrhh/rrhh_combustibles-lubricantes/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_computo(id) {
  $.ajax({
    url: "/rrhh/rrhh_equipos-computo/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_otros_suministros(id) {
  $.ajax({
    url: "/rrhh/rrhh_otros-suministros/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_construccion(id) {
  $.ajax({
    url: "/rrhh/rrhh_material-construccion/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_repuestos(id) {
  $.ajax({
    url: "/rrhh/rrhh_repuestos-accesorios/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_agricultura(id) {
  $.ajax({
    url: "/rrhh/rrhh_materiales-agricultura/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function editarProducto_proteccion(id) {
  $.ajax({
    url: "/rrhh/rrhh_equipos-proteccion/" + id + "/",
    type: "GET",
    success: function (data) {
      // Llenar el formulario con los datos del producto
...
function initPresupuesto(config) {
  ...
  return function () {
    ...
    const calcularTotalPresupuesto = () => {
      return new Promise((resolve, reject) => {
        $.ajax({
          url: "/rrhh/rrhh_suministros_totals_dl/",
          type: "GET",
          dataType: "json",
          success: function (data) {
            $(totalSelector).text(
