if (typeof window.presupuestoMaterialesInitialized === "undefined") {
  ...
  function actualizarTotalSueldos() {
    $.ajax({
      url: "/rrhh/rrhh_sueldo_mensual_cv/",
      type: "GET",
      dataType: "json",
  ...
  function actualizarTotalSalarios() {
    $.ajax({
      url: "/rrhh/rrhh_salario_mensual_cv/",
      type: "GET",
      dataType: "json",
      success: function (response) {
        const totalAnual = response.data.find(
  ...
  function initPresupuestoSueldos() {
    ...
    $("#formSueldoSalario")
      ...
      .on("submit", function (e) {
        ...
        $.ajax({
          url: isUpdate
            ? `/rrhh/rrhh_sueldos_cv/${formId}/`
            : "/rrhh/rrhh_sueldos_cv/",
  ...
  function initPresupuestoSalarios() {
    ...
    $("#formSalario")
      ...
      .on("submit", function (e) {
        ...
        $.ajax({
          url: isUpdate
            ? `/rrhh/rrhh_salarios_cv/${formId}/`
            : "/rrhh/rrhh_salarios_cv/",
          type: isUpdate ? "PUT" : "POST",
          contentType: "application/json",
          data: JSON.stringify(jsonData),
          success: function (response) {
