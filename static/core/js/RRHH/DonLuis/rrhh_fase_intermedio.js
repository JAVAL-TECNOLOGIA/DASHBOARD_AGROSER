...
$(document).ready(function() {
    ...
    $('#filtroCampaniaDesempeno').on('change', function() {
        if (tablaEvaluacionesIntermedio) {
            ...
            var nuevaUrl = '/rrhh/api/fase-intermedia/?id_area=12&campania=' + periodo;
...
function inicializarTablaEvaluacionesIntermedio() {
    var periodo = $('#filtroCampaniaDesempeno').val() || new Date().getFullYear();
    var urlAjax = '/rrhh/api/fase-intermedia/?id_area=12&campania=' + periodo;
                    ...
                    return `
                        <div class="btn-group" role="group">
                            ...
                            <button type="button" class="btn btn-success btn-sm" 
                                    onclick="EmailManagerRRHH.generarEnviarPDFEvaluacion(${row.id_evaluacion})" 
...
function cargarDatosSeguimientoAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/rrhh/api/fase-intermedia/?campania=${periodo}`,
        type: 'GET',
        dataType: 'json',
...
function cargarComentariosExistentes(id_evaluacion) {
    ...
    $.ajax({
        url: `/rrhh/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&cargar_comentarios=true`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
