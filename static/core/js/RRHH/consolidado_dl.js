...
//     const campania = getCampaniaActual();

//     const url = new URL("/rrhh/rrhh_sueldo_mensual/", window.location.origin);
//     if (campania) url.searchParams.set("campania", campania);
...
//     const url = new URL("/rrhh/rrhh_salario_mensual/", window.location.origin);
//     if (campania) url.searchParams.set("campania", campania);
...
async function obtenerConsolidadoSueldosYSalarios() {
  try {
    ...
    const responseSueldos = await fetchDataConReintento(
      `/rrhh/rrhh_sueldo_mensual/?year=${year}`,
      5,
      2000
    );
    ...
    const responseSalarios = await fetchDataConReintento(
      `/rrhh/rrhh_salario_mensual/?year=${year}`,
      5,
      2000
    );
...
$(document).ready(function () {
  ...
  $("#recargarConsolidadoSueldosSalarios").on("click", function (e) {
    ...
    obtenerConsolidadoSueldosYSalarios().finally(() => {
...
$("#recargarTodoRH").on("click", function () {
