...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/evaluaciones/evaluaciones_capex_cv/",
      dataSrc: "data",
    },
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "evaluaciones/evaluaciones_capex_cv");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/evaluaciones/evaluaciones_capex_cv/" + formId + "/"
        : "/evaluaciones/evaluaciones_capex_cv/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/evaluaciones/evaluaciones_capex_cv/" + id + "/",
    type: "GET",
    success: function (data) {
