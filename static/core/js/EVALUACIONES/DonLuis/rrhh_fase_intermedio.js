...
$(document).ready(function() {
    ...
    $('#filtroCampaniaDesempeno').on('change', function() {
        if (tablaEvaluacionesIntermedio) {
            ...
            var nuevaUrl = '/evaluaciones/api/fase-intermedia/?id_area=9&campania=' + periodo;
...
function inicializarTablaEvaluacionesIntermedio() {
    var periodo = $('#filtroCampaniaDesempeno').val() || new Date().getFullYear();
    var urlAjax = '/evaluaciones/api/fase-intermedia/?id_area=9&campania=' + periodo;
                    ...
                    return `
                        <div class="btn-group" role="group">
                            ...
                            <button type="button" class="btn btn-success btn-sm" 
                                    onclick="EmailManagerEvaluaciones.generarEnviarPDFEvaluacion(${row.id_evaluacion})" 
...
function cargarDatosSeguimientoAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/evaluaciones/api/fase-intermedia/?campania=${periodo}`,
        type: 'GET',
        dataType: 'json',
...
function cargarComentariosExistentes(id_evaluacion) {
    ...
    $.ajax({
        url: `/evaluaciones/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&cargar_comentarios=true`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaObjetivosAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/evaluaciones/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=1`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function cargarTablaCompetenciasAvance(id_evaluacion) {
    ...
    $.ajax({
        url: `/evaluaciones/api/detalles-evaluacion/?id_evaluacion=${id_evaluacion}&tipo=2`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
...
function actualizarAvancesEnServidor(tipo, actualizaciones, tipoNombre, callback, comentarios = {}) {
    ...
    $.ajax({
        url: '/evaluaciones/api/detalles-evaluacion/',
        type: 'PUT',
