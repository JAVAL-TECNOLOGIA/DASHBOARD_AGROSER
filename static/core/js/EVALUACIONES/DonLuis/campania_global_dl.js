...
// 1) Agrega ?year=... a todo $.ajax GET de /evaluaciones/
// 2) Agrega ID_CAMPANIA al body de todo $.ajax POST de /evaluaciones/
$.ajaxPrefilter(function (options, originalOptions, jqXHR) {
  if (!options.url) return;
  if (!options.url.startsWith("/evaluaciones/")) return;
