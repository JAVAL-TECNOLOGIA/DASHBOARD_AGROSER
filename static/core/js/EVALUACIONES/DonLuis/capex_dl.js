...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/evaluaciones/evaluaciones_capex/",
      dataSrc: "data",
    },
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate ? "/evaluaciones/evaluaciones_capex/" + formId + "/" : "/evaluaciones/evaluaciones_capex/",
 ...
 */
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/evaluaciones/evaluaciones_capex/" + formId + "/"
        : "/evaluaciones/evaluaciones_capex/",
      type: isUpdate ? "PUT" : "POST",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
      success: function (response) {
...
function editarProducto_capex(id) {
  $.ajax({
    url: "/evaluaciones/evaluaciones_capex/" + id + "/",
    type: "GET",
    success: function (data) {
