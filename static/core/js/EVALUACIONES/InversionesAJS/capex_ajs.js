...
function initCapexTable() {
  ...
  var table = $("#capexTable").DataTable({
    ...
    ajax: {
      url: "/evaluaciones/evaluaciones_capex_ajs/",
      dataSrc: "data",
    },
  ...
  $("#capexTable tbody").on("click", ".eliminar-capex", function () {
    var id = $(this).data("id");
    eliminarProducto_capex(id, "evaluaciones/evaluaciones_capex_ajs");
  });
  ...
  $("#registerMaterialForm_capex").submit(function (e) {
    ...
    $.ajax({
      url: isUpdate
        ? "/evaluaciones/evaluaciones_capex_ajs/" + formId + "/"
        : "/evaluaciones/evaluaciones_capex_ajs/",
...
function editarProducto_capex(id) {
  ...
  $.ajax({
    url: "/evaluaciones/evaluaciones_capex_ajs/" + id + "/",
    type: "GET",
    success: function (data) {
