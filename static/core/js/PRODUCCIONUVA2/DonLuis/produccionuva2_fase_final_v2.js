...
function inicializarTablaEvaluacionesFinal() {
    tablaEvaluacionesFinal = $("#tablaEvaluaciones_final").DataTable({
        ...
        ajax: {
            url: "/produccionuva2/api/fase-final/",
            type: "GET",
            data: function (d) {
                d.id_area = 14;
...
function cargarDatosSeguimientoAvanceFinal(id_evaluacion) {
    ...
    $.ajax({
        url: `/produccionuva2/api/fase-final/?id_area=14&campania=${campania}`,
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            console.log('Response cargarDatosSeguimientoAvanceFinal /produccionuva2/api/fase-final/');
...
const EmailManagerFinal = {
  ...
  config: {
    ...
    scripts: {
      competenciasPaths: [
        "/static/core/js/produccionuva2/DonLuis/produccionuva2_ev_competencias_v2.js",
      ],
    },
    messages: {
      confirmation: {
